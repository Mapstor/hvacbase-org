...
const footerLinks = {
  'Calculators & Tools': [
    ...
    { label: 'SEER2 Savings Calculator', href: '/seer2-comparison-calculator' },
  ...
  'Heating Systems': [
    ...
    { label: 'Heat Pump in Cold Weather', href: '/heat-pump-in-cold-weather' },
    { label: 'Furnace Maintenance', href: '/hvac-maintenance-checklist' },
  ...
  'Energy Efficiency': [
    ...
    { label: 'EER2 Rating', href: '/eer-chart-for-ac-units' },
    { label: 'COP Explained', href: '/coefficient-of-performance' },
    { label: 'MERV Ratings', href: '/merv-rating-chart' },
    { label: 'Tax Credits', href: '/hvac-tax-credits-2026' },
    { label: 'Insulation R-Value Guide', href: '/insulation-r-value-guide' },
    { label: 'Energy Saving Tips', href: '/hvac-energy-saving-tips' },
    { label: 'Programmable vs Smart Thermostat', href: '/smart-thermostat-savings' },
  ],
  'Indoor Air Quality': [
    { label: 'Air Purifier Sizing', href: '/air-purifier-sizing-guide' },
    { label: 'Air Purifier Guide', href: '/air-purifier-guide' },
    { label: 'Dehumidifiers', href: '/dehumidifier-guide' },
    { label: 'HEPA Filter Explained', href: '/hepa-filter-explained' },
    { label: 'MERV Rating Chart', href: '/merv-rating-chart' },
    { label: 'UV Light HVAC Systems', href: '/uv-light-hvac-systems' },
    { label: 'Allergen Control Guide', href: '/how-to-improve-indoor-air-quality' },
    { label: 'Air Quality Testing', href: '/indoor-air-quality-testing' },
    { label: 'Mold Prevention', href: '/how-to-identify-mold' },
