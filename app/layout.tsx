...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'In-depth HVAC guides with 355 articles, 9 interactive calculators, and editorially independent recommendations for all your heating and cooling needs.',
    images: [
      {
        url: '/opengraph-image',
        width: 1200,
