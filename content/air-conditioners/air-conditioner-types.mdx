...
When comparing upfront cost across types, cost-per-BTU puts them on equal footing. See the [Air Conditioner BTU Calculator](/air-conditioner-btu-calculator) to size the right capacity for your room before using the table below.
...
*At $0.18/kWh, 8 hrs/day, 125 days/year (illustrative — see the calculator).*
