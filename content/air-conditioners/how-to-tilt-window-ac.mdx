...
On a growing list of newer designs — Midea U-Shaped, GE Profile ClearView, some LG Dual Inverters — the manual says do not tilt at all, because the drain path was re-engineered to sit level. No paid placement here; the guidance below is drawn straight from spec sheets, install manuals, and the physics of how these units actually shed water.
