...
*Based on 8 hrs/day, 125 days/year, $0.18/kWh national average (illustrative — see the calculator).*
...
*Annual cost: 8 hrs/day, 125 days, $0.18/kWh (illustrative — see the calculator).*
...
| 2 | GE Profile PHC08LY ClearView | 13.5 | 43 dB | Inverter, Low-Profile | $380 | $48 |
| 3 | TCL 8W3E1-A Inverter | 13.2 | 44 dB | Inverter | $300 | $49 |
| 4 | Frigidaire Gallery GHWQ083WC1 | 12.2 | 44 dB | ENERGY STAR | $280 | $53 |
...
| 2 | GE Profile PHC10LY ClearView | 13.0 | 44 dB | Inverter, Low-Profile | $450 | $62 |
| 3 | Frigidaire Gallery GHWQ103WC1 | 12.1 | 45 dB | ENERGY STAR | $340 | $67 |
| 4 | Haier QHNG10AC Serenity | 11.9 | 46 dB | ENERGY STAR | $330 | $68 |
...
| 2 | GE Profile PHC12LY ClearView | 12.8 | 44 dB | Inverter, Low-Profile | $520 | $76 |
| 3 | Frigidaire Gallery GHWQ123WC1 | 11.8 | 46 dB | ENERGY STAR | $400 | $82 |
| 4 | Friedrich CCF12A10A Chill Premier | 11.5 | 47 dB | ENERGY STAR | $480 | $84 |
...
<Callout type="info">
**The math gets more favorable in high-cost states.** At the national average of $0.18/kWh, the payback period for an inverter unit is long. But in states with high electricity costs, the savings accelerate dramatically. In California ($0.297/kWh), the top inverter unit saves $140 over 8 years compared to the budget unit. In Connecticut ($0.286/kWh), savings are $135. In Massachusetts ($0.296/kWh), $139.
</Callout>
...
| National Average | $0.18 | $64 | $35 | $29 | $232 |
...
Some utilities and state efficiency programs offer rebates for ENERGY STAR certified room air conditioners. Rebate amounts, eligibility rules, and program windows vary by service territory and change frequently, so a single national table would go stale within a season.

<Callout type="tip">
**Check the DSIRE database** (Database of State Incentives for Renewables & Efficiency) at dsireusa.org for rebates specific to your address and location. Programs change frequently, and some only run during spring or early summer when inventory is high.
</Callout>
...
6. **Check DSIRE for utility rebates in your area** — where offered, ENERGY STAR room AC rebates can offset part of the price premium for efficient models.
...
<FAQ questions={[
  ...
  },
  {
    ...
    answer: "An 8,000 BTU window AC running 8 hours per day uses approximately 65–100 kWh per month, depending on efficiency. At about $0.18/kWh, that's roughly $12–$18/month. A 12,000 BTU unit uses 95–150 kWh/month (roughly $17–$27/month). Use the calculator for your exact rate. Inverter models use 20–40% less than these ranges. Your actual usage depends on how many hours you run it, your outdoor temperature, and how well-insulated your room is."
  },
  {
  ...
  },
  {
    ...
    answer: "There are no federal tax credits for window air conditioners. The Inflation Reduction Act's §25C (Energy Efficient Home Improvement) and §25D (Residential Clean Energy) credits — which covered qualifying heat pumps, central AC, and other property — were terminated for property placed in service after Dec 31, 2025 under the One Big Beautiful Bill Act (OBBBA, PL 119-21), and never covered room air conditioners in any case. Some utilities and state efficiency programs still offer rebates for ENERGY STAR certified window ACs; check dsireusa.org for programs in your area."
  },
  {
