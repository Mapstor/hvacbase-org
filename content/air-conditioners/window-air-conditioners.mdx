...
The indoor and outdoor sections are separated by an internal partition, so window ACs recirculate room air rather than pulling in outside air — see [Do Window ACs Pull Air From Outside?](/do-portable-acs-pull-air-from-outside) for details on the fresh-air vent, smoke/pollution sealing, and gap infiltration.
...
Use the calculator below to size your unit — as a rule of thumb, you need roughly 20 BTU per square foot, adjusted for sun, ceilings, and occupancy.
...
| CEER Rating | Efficiency Level |
|---|---|
| 10.0–11.0 | Minimum (DOE standard) |
| 11.0–12.0 | Good |
| 12.0–13.5 | Very Good (ENERGY STAR) |
| 13.5–15.0 | Excellent (ENERGY STAR Most Efficient) |
| 15.0+ | Best Available (Inverter models) |

A higher CEER means lower electricity bills for the same cooling. The BTU calculator above sizes your unit but does not compute running cost; for illustrative dollar figures and the formula behind them, see the running-cost formula and worked examples further down this guide.
...
The traditional design that sits on your windowsill with the back half hanging outside. These remain the most affordable and widely available option. For a direct efficiency, noise, and cost comparison against portables, see [Portable vs Window AC](/portable-vs-window-ac).
...
*Based on 8 hours/day, 125 days/year (mid-May through mid-September), $0.18/kWh national average (illustrative — see the calculator).*
