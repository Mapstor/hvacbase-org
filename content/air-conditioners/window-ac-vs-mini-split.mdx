...
<Callout type="example">
**Example: Homeowner's Long-Game (2025 install)**
The Reeves family bought a 1960s ranch in Raleigh, NC with no central AC. They chose a two-zone mini split (Fujitsu 18,000 BTU, SEER2 22) installed in **2025** for $5,400. It provides cooling in summer and efficient heat pump heating in winter, replacing both window ACs and two space heaters. Their estimated annual savings: $350/year in combined heating and cooling costs. With utility rebates ($400) and the federal 25C credit (30%, up to $2,000) claimed on their 2025 return before the OBBBA termination, their effective cost dropped to $2,380. Payback: about 7 years. For a 2026 install of the same system, the 25C credit no longer applies — effective cost would be $5,000 after the utility rebate alone, or as low as $0 with IRA HEAR stacking for income-qualified households.
</Callout>
...
<Callout type="tip">
**Rebates can tip the scale further.** The federal Section 25C credit (30%, up to $2,000 for heat pump mini splits) **expired for installs after Dec 31, 2025** under the OBBBA. For 2026 installs, many states and utilities still offer $200–$1,000 in rebates, plus IRA HEAR (income-qualified, up to $8,000) and HOMES (performance-based). These incentives don't apply to window ACs. A $3,000 mini split installed in 2026 can drop to $1,000–$2,500 after state/utility rebates alone, or much lower for income-qualified households stacking IRA HEAR — much closer to a window AC's price point.
</Callout>
...
- You qualify for **state/utility rebates and IRA HEAR/HOMES** for 2026 installs (can reduce cost 15–40%). The federal 25C tax credit (which previously added up to $2,000 for qualifying heat pump mini splits) expired Dec 31, 2025 under the OBBBA.
...
5. **State/utility rebates + IRA HEAR/HOMES can cut 2026 mini split cost by 15–40%** (the federal 25C credit that previously added $2,000 for qualifying heat pump mini splits expired Dec 31, 2025 under the OBBBA).
