...
Noise is the #1 factor that determines whether you'll actually use a tower fan at night. Here's how models compare across speed settings based on manufacturer-published specifications:
