...
Two contractors walked through your house and their estimates disagreed on the tonnage — one wrote 4, the other 3.5, and maybe a third said 5. Your fifteen-year-old central AC has to go, and you'd rather not spend $8,000 on a system that short-cycles all summer or runs flat out at 3pm every July afternoon.

This page reconciles the two ways HVAC pros actually size equipment: the square-feet-per-ton rule of thumb (which shifts from 350 to 800 sq ft per ton depending on climate zone) against an ACCA Manual J-style load calculation with adjustment factors for ceilings, windows, insulation vintage, ducts, and kitchen gains.

You get a chart covering every home from 500 to 5,000 sq ft across five climate zones, three worked examples where the two methods disagree, and the standard residential lineup — 1.5 through 5 tons, since nothing bigger comes in a single unit.

The example most people find surprising: a 1,200 sq ft new-build condo in Portland pencils out to 1.5 tons, but a contractor using a stale "500 sq ft per ton" rule will quote 2.5 tons — a 67% oversize with real humidity consequences. Every number here traces to ACCA methodology, the AHRI product directory, or public EIA rates. No brand paid to appear.
