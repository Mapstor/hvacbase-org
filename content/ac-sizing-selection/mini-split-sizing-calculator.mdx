...
## Interactive Mini Split Sizing Calculator

Add up to 5 zones to size your multi-zone ductless system:
...
**Cold-climate mini splits are essential in Zones 5–7.** Standard mini splits lose 20–40% of their heating capacity as outdoor temperatures drop below 20°F and may shut down entirely below 5°F. Cold-climate models maintain 75–100% capacity down to −13°F and operate down to −22°F depending on the unit: Daikin Aurora to −13°F (AHRI-certified), Fujitsu XLTH to −15°F (per Fujitsu General spec), and select Mitsubishi Hyper-Heat / Cooper & Hunter HPR configurations to −22°F (manufacturer-rated). Always check the published heating capacity at your local design temperature, not just the rated capacity at 47°F.
</Callout>
...
<FAQ>
  ...
  <FAQ.Item question="Do mini splits work in cold climates?">
    Yes, but you need cold-climate rated models. Standard mini splits lose 20–40% of heating capacity below 20°F and may shut off below 5°F. Cold-climate models maintain 75–100% capacity to −13°F and operate down to −22°F depending on the unit: Daikin Aurora -13°F (AHRI-certified), Fujitsu XLTH -15°F (per Fujitsu General spec), select Mitsubishi Hyper-Heat / Cooper & Hunter HPR configurations -22°F (manufacturer-rated). These cost 15–25% more than standard models but are essential in Zones 5–7. Some homeowners keep a backup heating source (electric baseboard, gas furnace) for the coldest extremes.
  </FAQ.Item>
  ...
  <FAQ.Item question="How much does a mini split cost to install in 2026?">
    Single-zone mini split installation costs $2,000–$5,000 total (unit + labor) for a 9,000–18,000 BTU system. Multi-zone systems run $5,000–$15,000 for 2–4 zones. Costs vary by region, brand, line set length, and installation complexity. Premium brands (Mitsubishi, Daikin) cost 20–40% more than budget brands. The federal Section 25C credit (which covered 30% of cost up to $2,000) expired for installs after Dec 31, 2025 under the OBBBA; for 2026 installs, state and utility rebates plus IRA HEAR (income-qualified, up to $8,000) and HOMES (open to all incomes, performance-based) are the active federal/state pathways.
  </FAQ.Item>
</FAQ>
