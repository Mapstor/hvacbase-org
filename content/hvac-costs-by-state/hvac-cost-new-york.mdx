...
Individual utility service territories also run their own heat-pump, AC, and weatherization rebates that stack on top of NYSERDA and federal programs. Because these programs change frequently and vary by ZIP code, check the DSIRE database (dsireusa.org) for the current offerings in your area before you sign a contract.
...
- NYSERDA and federal (IRA HEAR/HOMES) incentives can offset $3,000–$11,000+ of heat pump costs (25C ended Dec 31, 2025)
