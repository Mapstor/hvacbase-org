...
<BatteryRuntimeByLoad caption="Runtime of a single 13.5 kWh Tesla Powerwall 3 across three load-level scenarios. Whole-home row shows the article's primary guidance ('need 2-3 batteries or battery + solar') and a derived single-battery estimate (8-13 hrs, from 13.5 ÷ 25-40 kWh/day). Peak-output caveat: continuous kW matters as much as capacity kWh." />
