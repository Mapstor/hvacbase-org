...
<FAQ questions={[
  ...
  },
  {
    ...
    answer: "Through Dec 31, 2025, the federal residential Section 25D Investment Tax Credit allowed homeowners to deduct 30% of total solar installation cost from federal income taxes (panels, inverters, batteries, labor, permitting). For a 2025 $20,000 install, the credit was $6,000. **The 25D credit expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). 25D allows carryforward of an unused pre-2026 credit to future tax years. For 2026 solar installs, state and utility incentives plus net metering are the active pathways. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)"
  },
  {
