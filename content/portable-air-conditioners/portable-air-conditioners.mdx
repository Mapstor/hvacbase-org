...
Use the calculator below to size your unit — as a rule of thumb, you need roughly 20 BTU per square foot, adjusted for sun, ceilings, and occupancy. Note that portable ACs are rated in DOE BTU, which runs lower than the old ASHRAE number for the same unit.
...
| AC Type | CEER / SEER2 | Relative Operating Cost |
|---------|-------------|-------------------------|
| Portable AC (single-hose) | 7.0–9.5 CEER | Highest |
| Portable AC (dual-hose) | 8.5–11.0 CEER | High |
| Window AC | 10.0–15.0 CEER | Lower |
| Mini-split | 18–30 SEER2 | Lowest |

Portable ACs sit at the bottom on efficiency, so they cost the most to run per hour of the four types here; a dual-hose model narrows the gap, while window units and mini-splits pull well ahead. The BTU calculator above sizes your unit but does not estimate running cost — for a dollar figure at your local rate and usage, see [How Much Electricity Does a Portable AC Use?](/portable-ac-electricity-cost).
...
For quiet-operation dB comparisons across AC types, see our [HVAC noise levels guide](/hvac-noise-levels-explained).
...
<Callout type="tip">
**Upgrade your window seal.** The included plastic panels are functional but not great. Aftermarket foam or plexiglass seal kits reduce hot air infiltration by 20%–40% and improve your unit's effective cooling. See our [portable AC venting guide](/how-to-vent-portable-ac-without-window).
</Callout>
