...
These costs are illustrative, assuming 8 hours of daily use at roughly the $0.18/kWh national average — use the calculator for your exact numbers. Your actual costs depend on your local rate, how many hours you run the unit, and ambient temperature.
