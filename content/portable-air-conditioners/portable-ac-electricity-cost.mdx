...
A typical 10,000 DOE BTU portable AC draws 1,000–1,200 watts and costs ≈$0.16–$0.23 per hour to run at the national average electricity rate of $0.18/kWh. That works out to ≈$1.27–$1.86 per day (8 hours), ≈$38–$56 per month, and ≈$190–$281 per cooling season (4 months) — use the calculator for your exact numbers. Your actual cost depends on three things: the unit's wattage, your electricity rate, and how many hours you run it.
...
For example: A 1,100W portable AC costs **≈$0.20 per hour at ~$0.18/kWh** — use the calculator.

Multiply by hours per day, days per month, and months per season for larger timeframes.

## Cost by BTU Size

| DOE BTU Rating | Typical Wattage | Hourly Cost (illustrative at ~$0.18/kWh — use the calculator) | Daily (8 hrs) | Monthly (30 days) | Seasonal (120 days) |
|---------------|----------------|------------------------|---------------|-------------------|-------------------|
...
| National average | $0.18 | $0.20 | $48 | $191 |
...
| CEER Rating | Unit Type (Example) | Wattage for 10K BTU | Monthly Cost (illustrative at ~$0.18/kWh, 8 hrs/day — use the calculator) | Annual Savings vs. CEER 8.0 |
|-------------|-------------------|---------------------|-------------------------------------|---------------------------|
...
Payback timing depends on offset value and net installed cost after all applicable incentives. On a gross $4,000 system offsetting 800 kWh per year, annual bill savings at a retail rate of $0.30/kWh (California, Massachusetts) equal $240 and simple payback runs 17 years; a hypothetical 30% credit shortens that payback to roughly 12 years. At the $0.18/kWh national average, annual savings drop to about $144 and payback extends past 25 years even with a 30% credit applied. At Hawaii's $0.40+/kWh rates, payback compresses to under 10 years.
...
- **A typical portable AC costs ≈$0.16–$0.23/hour** to run at $0.18/kWh (national average).
...
<FAQ items={[
  {
    ...
    answer: "A 10,000 DOE BTU portable AC (1,100W) running continuously for 24 hours at $0.18/kWh costs ≈$4.75. In practice, the compressor cycles on and off, so actual 24-hour costs are typically ≈$3.18–$4.02. At California's $0.30/kWh rate, 24-hour cost rises to $5.30–$6.70."
  },
  {
  ...
  },
  {
    ...
    answer: "If you only need to cool one room, a portable AC is much cheaper. A 3-ton central AC drawing 3,000W costs ≈$0.54/hour vs. ≈$0.20/hour for a portable. But central AC cools your entire home while a portable AC cools one room. If you need whole-home cooling, central AC is more efficient per BTU across all rooms combined."
  },
  {
