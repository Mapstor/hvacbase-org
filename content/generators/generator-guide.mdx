...
This guide walks you through every decision — from sizing and fuel type to installation and maintenance — so you buy the right generator the first time and avoid the two most common (and expensive) mistakes: buying too small and burning out the unit, or buying too big and wasting thousands on capacity you never use. For runtime by fuel amount, see our [5-gallon runtime chart](/how-long-generator-on-5-gallons); for the storage-based alternative, our [generator vs. solar battery comparison](/generator-vs-solar-battery-backup).
