...
This guide walks you through every decision — from sizing and fuel type to installation and maintenance — so you buy the right generator the first time and avoid the two most common (and expensive) mistakes: buying too small and burning out the unit, or buying too big and wasting thousands on capacity you never use. For runtime by fuel amount, see our [5-gallon runtime chart](/propane-generator-usage-per-hour); for the storage-based alternative, our [home battery backup guide](/home-battery-backup-guide) walks through capacity sizing and outage-duration math for battery-only setups.
