...
<ComparisonTable
  title="Federal Tax Credit Comparison (EXPIRED for installs after Dec 31, 2025)"
  headers={["Feature", "Air-Source (25C — EXPIRED)", "Ground-Source (25D — EXPIRED)"]}
  rows={[
...
<FAQ id="faq">
  ...
  <FAQ.Item question="What's the geothermal tax credit for 2026?">
    The federal Section 25D Residential Clean Energy Credit (30% of total installed cost, no cap, for qualifying geothermal heat pumps) **expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). For a 2025 install of a $30,000 geothermal system, the credit was $9,000; for a 2026 install of the same system, the federal 25D credit no longer applies. If you installed a qualifying geothermal system in 2024 or 2025 and didn't claim the credit, you can file an amended return (Form 1040-X) — 25D allows carryforward of an unused credit to future tax years. For 2026 geothermal installs, the active federal pathways are state/utility rebates plus IRA HOMES (open to all incomes, performance-based, tied to modeled or measured whole-home energy savings). (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)
  </FAQ.Item>
  ...
  <FAQ.Item question="Air-source or geothermal for a new build?">
    For new construction, geothermal deserves serious consideration. Ground loop installation costs are 30–40% lower when the site is already being excavated. (The 30% uncapped federal Section 25D credit that previously significantly reduced the cost gap expired Dec 31, 2025 under the OBBBA (PL 119-21, signed July 4, 2025); 25D allows carryforward of unused pre-2026 credit but no new credit accrues for 2026 installs. State and utility geothermal incentives plus IRA HEAR/HOMES for the heat-pump-component portion remain available pathways.) You'll benefit from the system's full 50+ year loop lifespan. If your budget is tight, a cold-climate air-source heat pump is still an excellent choice — just not quite as efficient over the system's lifetime.
  </FAQ.Item>
</FAQ>
