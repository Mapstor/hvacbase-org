...
<ComparisonTable
  ...
  headers={["System Type", "Total Installed Cost", "After State/Utility Rebates*", "Typical Payback Period"]}
  rows={[
    ["Ducted Air-Source (standard)", "$4,500–$8,500", "$3,500–$8,000", "5–8 years"],
    ["Ducted Air-Source (premium)", "$8,000–$12,500", "$7,000–$12,000", "6–10 years"],
    ["Mini Split (single zone)", "$2,700–$5,800", "$1,700–$5,300", "3–6 years"],
    ["Mini Split (multi-zone, 3–4 heads)", "$9,500–$19,000", "$8,500–$18,500", "6–9 years"],
    ["Mini Split DIY (single zone)", "$1,400–$2,200", "$1,400–$2,200*", "1–4 years"],
    ["Ground-Source / Geothermal", "$18,000–$35,000", "$17,000–$32,000**", "12–20 years"],
  ]}
/>
...
**State + Utility Rebates:** Range from $500 to $16,000 depending on your state and utility. See our complete [tax credits and rebates guide](/heat-pump-tax-credits-2026/). (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)

<ComparisonTable
  title="Example 2026 After-Incentive Costs (3-ton Ducted, $9,000 Base — Federal 25C EXPIRED Dec 31, 2025)"
  headers={["Scenario", "Base Cost", "Federal 25C Credit", "State/Utility Rebate", "IRA HEAR (income-qualified)", "Net Cost"]}
  rows={[
    ["No incentives", "$9,000", "$0 (EXPIRED)", "$0", "$0", "$9,000"],
    ["State/utility only (moderate)", "$9,000", "$0 (EXPIRED)", "−$2,500", "$0", "$6,500"],
    ["State/utility only (strong state — MA)", "$9,000", "$0 (EXPIRED)", "−$10,000", "$0", "−$1,000*"],
    ["IRA HEAR only (income-qualified)", "$9,000", "$0 (EXPIRED)", "$0", "−$8,000", "$1,000"],
    ["State/utility + IRA HEAR stacked (income-qualified, moderate state)", "$9,000", "$0 (EXPIRED)", "−$2,500", "−$8,000", "−$1,500*"],
  ]}
/>
...
**Get at least 3 quotes.** Pricing varies widely between contractors — quotes for identical systems commonly range from $6,500 to $12,000 in the same market. Three quotes give you a clear picture of the fair market rate.
...
<FAQ id="faq">
  ...
  <FAQ.Item question="Is it cheaper to install a heat pump or a furnace and AC?">
    A gas furnace + AC combo costs $4,500–$6,500 installed, versus $5,800–$10,000 for a heat pump. The federal 25C credit (which covered up to $2,000 for qualifying heat pumps) expired for installs after Dec 31, 2025, so it no longer helps close that gap. State and utility rebates plus IRA HEAR / HOMES often still narrow the difference. The heat pump also saves $500–$1,200/year on operating costs, making it the cheaper long-term choice in most cases.
  </FAQ.Item>
  ...
  <FAQ.Item question="Is a geothermal heat pump worth the extra cost?">
    A geothermal system costs 2–3× more upfront than an air-source heat pump ($18,000–$35,000 vs. $5,800–$10,000). However, it operates at 40–60% higher efficiency. Through Dec 31, 2025, geothermal qualified for the federal Section 25D credit at 30% of total cost with no cap ($5,400–$10,500 credit on the install range above). **The 25D credit expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025); 25D allows carryforward of an unused pre-2026 credit to future tax years (unlike 25C). For 2026 geothermal installs, the active federal pathway is IRA HOMES (open to all incomes, performance-based), plus state/utility geothermal rebates ($1,000–$5,000 in many states). The ground loop lasts 50+ years. Geothermal makes the most financial sense for new construction (lower loop installation cost), homes with high heating loads (zones 5–7), and homeowners planning to stay 15+ years.
  </FAQ.Item>
