...
**How significant is this?** Through Dec 31, 2025, the federal 25C credit covered up to $2,000 and state rebates added $1,000–$16,000, often making the heat pump the same price or cheaper than a furnace + AC. For 2026 installs the 25C credit has expired (OBBBA), but the IRA HEAR (income-qualified, up to $8,000) and HOMES (open to all incomes, performance-based) programs plus state and utility rebates remain the active federal/state pathways. In states like Massachusetts, New York, and Maine, aggressive incentives can still make the heat pump the cheaper option upfront.

**The workaround:** Stack state and utility incentives plus IRA HEAR / HOMES. The pre-OBBBA stack — a $9,000 heat pump with a $2,000 federal 25C credit and a $3,000 state rebate, costing $4,000 out of pocket — illustrates what was possible through 2025. The 2026 stack drops the 25C piece but typically adds IRA HEAR or HOMES, depending on income / measured savings. Check our [tax credits and rebates guide](/heat-pump-tax-credits-2026/) for the current 2026 federal/state landscape.
