...
\*\*Based on 2,000 sq ft home, zone 4, $0.18/kWh, $1.35/therm gas (illustrative).
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Annual cooling cost @ $0.18/kWh", "$306", "$306", "None"],
  ]}
/>
...
<ComparisonTable
  ...
  rows={[
    ["Heat Pump (HSPF2 10)", "HSPF2 10", "COP 2.93", "$1.80"],
    ["Heat Pump (HSPF2 8)", "HSPF2 8", "COP 2.34", "$2.25"],
    ["Gas Furnace (96% AFUE)", "96% AFUE", "COP 0.96", "$1.41"],
    ["Gas Furnace (80% AFUE)", "80% AFUE", "COP 0.80", "$1.69"],
    ["Electric Resistance", "100%", "COP 1.00", "$5.28"],
    ["Oil Furnace (85% AFUE)", "85% AFUE", "COP 0.85", "$3.50"],
  ]}
/>

*Assumes $0.18/kWh, $1.35/therm gas, $3.50/gal oil (illustrative).*

At the ~$0.18/kWh and ~$1.35/therm national averages, an HSPF2 10 heat pump (COP ≈2.9) costs about $1.80 per 100,000 BTU of heat versus roughly $1.41 for a 96% gas furnace — so on today's cheap gas the furnace is often a little cheaper per BTU, and the heating break-even sits near COP 3.8. A heat pump pulls clearly ahead where electricity is cheap, gas is expensive, or the climate is mild enough to hold a high COP, and it still wins big against oil, propane, and electric resistance. It also drops the gas service charge ($10–$20/month) and provides cooling from the same box, so run your own rates through the [running-cost calculator](/heat-pump-running-cost-calculator/) before deciding.
