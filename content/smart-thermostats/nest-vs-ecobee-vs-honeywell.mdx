  ...
  items={[
    {
      ...
      answer: "Per published ENERGY STAR connected-thermostat data, Ecobee's cooling-savings claim (20%) is higher than Nest's (15%). For heating, both manufacturers claim up to 23%. Ecobee uses occupancy sensors that actively detect empty rooms; Nest relies primarily on schedule predictions."
    },
    {
