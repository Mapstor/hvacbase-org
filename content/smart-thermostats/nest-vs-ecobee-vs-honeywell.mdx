...
<ComparisonTable
  ...
  rows={[
    ["Energy Savings", "Ecobee", "Up to 23% heating / 20% cooling — highest manufacturer-reported figures"],
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Heating Savings (mfg)", "Up to 23%", "Up to 23%", "Up to 20%"],
    ["Cooling Savings (mfg)", "Up to 20%", "Up to 15%", "Up to 20%"],
...
Ecobee reports up to **23% on heating and 20% on cooling** based on their own field studies. These figures are submitted with Ecobee's [ENERGY STAR v2.0 certification](https://www.energystar.gov/products/smart_thermostats/key_product_criteria), which independently verifies that certified models meet the ≥8% heating / ≥10% cooling floor — the higher "up to" ceiling comes from Ecobee's own data collection. Ecobee achieves savings through a combination of occupancy-based setbacks, geofencing, weather-responsive pre-conditioning, and their eco+ community energy program.
...
- You want the highest manufacturer-reported energy savings
...
4. **Manufacturer-reported ranges overlap significantly** across the three brands — the difference between brands is smaller than the difference between any smart thermostat and no smart thermostat
  ...
  items={[
    {
      ...
      answer: "Per manufacturer-reported figures, Ecobee's cooling-savings claim (up to 20%) is higher than Nest's (up to 15%). For heating, both manufacturers claim up to 23%. Ecobee uses occupancy sensors that actively detect empty rooms; Nest relies primarily on schedule predictions. Both meet the ENERGY STAR v2.0 minimum of 8% heating / 10% cooling; the higher figures are each manufacturer's own field data."
    },
    {
