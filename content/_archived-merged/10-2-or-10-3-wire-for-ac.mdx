...
- **240V circuits split into two categories** — AC condensers have zero 120V parts inside (just a 240V compressor, 240V fan, and 24V contactor from the thermostat transformer), while dryers need a neutral to feed a 120V drum motor, timer, and light
...
- **Heat pumps with strip backup are two separate 240V circuits, still neither with a neutral** — the outdoor unit stays on 10/2, but the indoor air handler's resistance element scales by kW: 5kW on 10/2 at 30A, 10kW on 8/2 or 6/2 at 50–60A, 15kW on 6/2 or larger at 60–80A
