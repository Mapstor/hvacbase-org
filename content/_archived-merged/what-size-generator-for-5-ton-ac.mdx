...
description: "A 5-ton AC unit requires a 17–20 kW generator minimum for reliable operation, or 14 kW with a hard-start kit. Complete generator sizing guide with surge calculations, and wiring requirements."
...
Use the calculator above to size your generator — as a rule of thumb, a 5-ton AC needs a generator that can handle its locked-rotor/starting surge, typically well above the running watts.
...
The calculator above computes your total generator size once you add household loads on top of the AC. As you stack essentials like a fridge, lights, and a well pump onto the compressor surge, the generator you need climbs — enter your loads above to get the number for your home.
...
Hard-start kits (sometimes sold as "compressor savers") are a widely available, inexpensive part — typically $40–$80 for the component — and any HVAC tech can match one to your compressor. They're a generic upgrade, not a single-brand product.
...
### Sizing a Generator for a 5-Ton AC

Use the calculator above to size for your exact loads. As a rule of thumb, a **standby unit in the 20–24 kW range** comfortably covers a 5-ton AC plus a typical home; if you're backing up the AC alone, **17–20 kW** is the floor. Large **portable generators (roughly 14 kW and up)** can work only with a hard-start kit fitted to the AC, and most portables can't handle the compressor surge otherwise. Whatever you buy, confirm its **surge/starting-watt** rating clears your AC's locked-rotor draw, not just the running watts.
...
**Key Takeaways:**
- Size to your data plate's Locked Rotor Amps (LRA × 240V = surge watts), not the running load — a 5-ton compressor's 42–63A LRA drives a 200–500 ms inrush that stalls units sized only for the 21–25A steady draw
