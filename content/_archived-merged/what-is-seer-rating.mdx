...
*Based on a 3-ton system, 1,500 cooling hours, $0.18/kWh (illustrative — see the calculator for exact figures).
...
At the ~$0.18/kWh national average, that's ≈$600/yr in cooling costs — use the calculator for your exact figure. The same system at 12 SEER would use 4,500 kWh and cost ≈$800/yr, roughly $200/year more.
...
**Ductwork condition** is the biggest variable. The DOE puts duct air losses at about 30% of a cooling system's energy consumption in typical homes. A 16 SEER system with 25% duct losses effectively performs like a 12 SEER system.
...
- **Each SEER point upgrade saves roughly $20-$40/year** for a typical 3-ton system at the ~$0.18/kWh national average.
...
<FAQ questions={[
  {
    ...
    answer: "For a 3-ton AC running 1,500 hours per year at the ~$0.18/kWh national average, each SEER point saves approximately $20-$40 per year. The savings per point are larger at lower SEER levels (going from 10 to 11 SEER saves more per point than going from 20 to 21) due to diminishing returns. Over a 15-year system lifespan, each point saves $300-$600."
  },
  {
