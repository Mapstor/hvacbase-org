...
<Callout type="example">
**Example: Jacksonville, FL — 1,600 sq ft home (2026 install).** Replacing a 3-ton system with a Goodman 16 SEER2 heat pump + air handler. Equipment: $4,400. Labor: $2,200. Materials: $500. Permits: $250. **Total: $7,350.** Federal 25C credit ($2,000) expired Dec 31, 2025 (OBBBA). **Net before rebates: $7,350.** With any local utility rebate that may apply plus IRA HEAR (income-qualified, up to $8,000) or HOMES (performance-based), 2026 net commonly lands well below sticker for non-income-qualified households or as low as $0 for income-qualified. Check DSIRE (dsireusa.org) for current programs in your area.
</Callout>
