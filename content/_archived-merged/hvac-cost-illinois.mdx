...
**The case for heat pumps in Illinois:** Cold-climate heat pumps now work effectively down to -13°F to -22°F, covering all but the most extreme Illinois cold snaps. They provide both heating and cooling from a single system. The federal 25C credit ($2,000 for qualifying heat pumps) expired for installs after Dec 31, 2025 (OBBBA); for 2026 installs, state/utility program rebates plus IRA HEAR (income-qualified, up to $8,000) and HOMES (performance-based) make them cost-competitive with traditional AC + furnace combos.
...
Illinois homeowners should check their state/utility program for current HVAC rebates. DSIRE ([dsireusa.org](https://www.dsireusa.org/)) maintains an up-to-date database of state, utility, and local incentives available in your area — filter by ZIP code and technology (heat pump, high-efficiency furnace, smart thermostat, duct sealing) to see what applies to your home.
...
- State/utility program rebates plus IRA HEAR (income-qualified, up to $8,000) or HOMES (performance-based) can offset thousands on a 2026 install (federal 25C credit no longer in the stack — expired Dec 31, 2025 under the OBBBA); check DSIRE for current programs in your area
