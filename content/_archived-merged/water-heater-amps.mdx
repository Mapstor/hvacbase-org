...
| Water Heater Type | Monthly kWh | Monthly Cost ($0.18/kWh — illustrative) | Annual Cost |
|-------------------|-------------|--------------------------|-------------|
...
- **NEC's 1.25× continuous-load factor drives breaker size, not raw amps.** 18.75A at the element becomes 23.4A after the multiplier — which is why a 4,500W tank needs a 30A double-pole breaker, not a 20A.
