...
The counterintuitive finding worth flagging up front: in a mild northern climate at 1,000 cooling hours and $0.13/kWh, jumping from the 13.4 minimum to 20 SEER2 saves roughly $80 a year — often a 25-plus year payback on a system that may not live that long. In a hot southern climate at 2,500 cooling hours and the ~$0.18/kWh national average, an upgrade to 20 SEER2 from the 14.3 minimum returns roughly $325 a year — use the calculator above for your exact figure. The specs and prices come from public sources; no affiliate deals steer the numbers.
...
**Electricity Rate ($/kWh):** Your cost per kilowatt-hour. Find this on your electric bill or use the U.S. average of $0.18/kWh. Rates range from $0.08/kWh in Louisiana to $0.36/kWh in Hawaii.
...
### Scenario 1: 3-Ton AC, $0.18/kWh, 1,500 Cooling Hours (illustrative — see the calculator for exact figures)
...
### Scenario 2: 3-Ton AC, $0.18/kWh, 2,500 Cooling Hours (Hot Climate — illustrative, see the calculator for exact figures)
...
<Callout type="tip">
**Notice the diminishing returns.** In the hot climate scenario at the ~$0.18/kWh national average, going from 14.3 to 18 SEER2 saves roughly $225/year, while going from 18 to 22 SEER2 (same 4-point jump) saves only about $175/year more (illustrative — use the calculator above for exact figures). The biggest efficiency gains come from moving away from the minimum. Each additional SEER2 point saves less than the one before it.
</Callout>
...
<ComparisonTable
  headers={["Upgrade", "Added Cost Range", "Annual Savings (1,500 hrs, $0.18/kWh — illustrative, see the calculator)", "Payback Range"]}
  rows={[
...
<ComparisonTable
  headers={["Assumption", "15-Year Savings (14.3 vs 18 SEER2, $0.18/kWh start, 1,500 hrs — illustrative, see the calculator)"]}
  rows={[
...
<FAQ questions={[
  {
    ...
    answer: "For a typical 3-ton system running 1,500 hours at the ~$0.18/kWh national average, each SEER2 point saves approximately $17-$45 per year (illustrative — use the calculator above for your exact figure). The savings per point are larger at lower SEER2 levels due to diminishing returns. Going from 14 to 15 SEER2 saves about $45, while going from 20 to 21 saves about $17."
  },
  {
