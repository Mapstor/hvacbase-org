...
California utility rebate programs vary widely by service territory and change frequently through the year as program budgets fill. The most reliable place to see current offers for your address is the DSIRE database (dsireusa.org) — filter by ZIP code and "HVAC" or "heat pump" to see live programs and dollar amounts. Publicly-owned utilities (municipal utilities and irrigation districts) generally offer richer heat pump rebates than investor-owned utilities, so it's worth checking even if you've priced a project before.
...
TECH Clean California ($3,000–$4,250) + BAAQMD (Bay Area, $2,500–$5,500) + local utility rebates (varies by service territory — check DSIRE) + IRA HEAR if income-qualified (up to $8,000) = **$5,500–$17,750+ in stacked incentives** depending on region and household eligibility. On a $13,000 heat pump installation, a non-income-qualified Bay Area household could net $3,250–$7,500 out of pocket; an income-qualified household could net as low as $0. The federal 25C credit ($2,000) is no longer in the 2026 stack — terminated for property placed in service after Dec 31, 2025 under the OBBBA (PL 119-21).
</Callout>
...
- California offers the most generous HVAC rebates in the nation — up to $17,750+ when stacking state programs (TECH Clean CA, BAAQMD), local utility rebates, and IRA HEAR for income-qualified households
...
<FAQ items={[
  {
    ...
    answer: "For most California homeowners, heat pumps are an excellent choice in 2026. California's mild winter climate is ideal for heat pump efficiency. When you factor in TECH Clean California rebates ($3,000–$4,250), any local utility rebate available in your service territory (check DSIRE for what's live in your ZIP), and (if income-qualified) IRA HEAR (up to $8,000), a heat pump can cost less out of pocket than a traditional AC + furnace system. The federal 25C credit ($2,000) expired Dec 31, 2025 (OBBBA) and is no longer part of the 2026 stack. Bay Area customers (via BAAQMD) and residents of publicly-owned utility territories generally see the best incentive stacking."
  },
  {
