...
<FAQ questions={[
  {
    ...
    answer: "Convert both to cost per BTU delivered. For a heat pump: Cost per 100,000 BTU = (100,000 / HSPF2) x (electricity rate / 1,000). For a gas furnace: Cost per 100,000 BTU = (100,000 / AFUE) x (gas rate per therm / 100,000). At typical U.S. rates (~$0.18/kWh, ~$1.35/therm), a heat pump with HSPF2 10 costs ≈$1.80 per 100K BTU, while a 96% AFUE furnace costs ≈$1.40 — use the calculator for your exact figures."
  },
  {
    question: "What does COP 3.0 mean in practical terms?",
    answer: "COP 3.0 means the system delivers 3 units of heating or cooling energy for every 1 unit of electricity consumed. In practical terms, at the ~$0.18/kWh national average, a heat pump with COP 3.0 costs ≈$1.75 to deliver 100,000 BTU of heat — use the calculator for your exact figure. For comparison, electric resistance heating (COP 1.0) would cost ≈$5.25 for the same heat. COP 3.0 is 300% efficient."
  },
  {
