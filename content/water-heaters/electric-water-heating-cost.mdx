...
This is the single most impactful upgrade. A HPWH uses 1,000–1,800 kWh/year versus 4,000–5,000+ kWh for a resistance tank. At the national average of $0.18/kWh, that's ≈$540–$720 per year in savings (illustrative).
...
<FAQ questions={[
  ...
  },
  {
    ...
    answer: "Only if you already have a gas line to the water heater location. Installing a new gas line costs $500–$2,500, which may negate the operating savings. A better option in most cases is switching from a standard electric tank to a heat pump water heater — no fuel conversion needed, same 240V circuit, and lower operating costs than gas. The 30% federal Section 25C tax credit is no longer a factor: it expired for units placed in service after Dec 31, 2025 under the OBBBA. For 2026 installs, state and utility rebates plus IRA HEAR (income-qualified) and HOMES (performance-based) programs are the paths to offset the higher upfront cost — check DSIRE or your state energy office."
  }
]} />
