...
<Callout type="tip">
Heat pump water heaters cost less to operate than gas tanks in most regions. The federal Section 25C credit (which previously covered 30% up to $2,000 for qualifying HPWHs) **expired for installs after Dec 31, 2025** under the OBBBA; for 2026 installs, IRA HEAR (income-qualified, up to $1,750 for water heaters) and HOMES (performance-based) plus state/utility rebates still meaningfully reduce the price gap vs a standard electric tank.
</Callout>
...
<Callout type="example">
**Real-World Example — The Patel Home (Atlanta, GA, 2025 install before OBBBA repeal):** The Patels switched from a 50-gallon gas tank in a cramped utility closet to a Rheem ProTerra 65-gallon heat pump water heater in their unfinished basement in **2025**. The installation required running new water lines 25 feet and a 240V circuit. Total installed cost: $3,400. Annual operating cost dropped from $290 to $140, saving $150/year. **Pre-OBBBA**: claimed a $1,020 federal 25C HPWH tax credit on their 2025 return; net cost $2,380; payback ~16 years. **For a 2026 install of the same unit**: the 25C credit no longer applies (OBBBA, PL 119-21, signed July 4, 2025); without state/utility rebates, payback stretches to ~22.7 years ($3,400 / $150/yr). Georgia Power and other GA utilities offer HPWH rebates ($200–$500) that bring 2026 payback to ~19–22 years; IRA HEAR (income-qualified, up to $1,750 for water heaters) and HOMES (performance-based) further compress payback for eligible households. Beyond the math, they also gained the closet space back.
</Callout>

## 2026 Federal Tax Credits and Rebates

**Federal Section 25C credit — EXPIRED for installs after Dec 31, 2025:** The credit that previously covered 30% of cost up to $2,000 per year for qualifying ENERGY STAR heat pump water heaters expired under the OBBBA (PL 119-21, signed July 4, 2025).

**Federal Section 25D credit — also EXPIRED Dec 31, 2025:** The 30% (no-cap) credit for solar water heaters expired under the same OBBBA repeal. Carryforward of an unused pre-2026 25D credit IS allowed (unlike 25C).

**For 2026 installs — active pathways:**

- **IRA HEAR** (income-qualified): point-of-sale rebates up to $1,750 for heat pump or electric water heaters.
- **IRA HOMES**: open to all incomes, performance-based rebates tied to modeled or measured energy savings.
- **State and utility rebates**: $150–$1,000+ for qualifying installations (varies by provider).

Both HEAR and HOMES are state-administered. Check the DSIRE database (dsireusa.org) for local incentives. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)
...
<FAQ questions={[
  ...
  },
  {
    ...
    answer: "No — the federal Section 25C credit (30% up to $2,000 for qualifying ENERGY STAR heat pump water heaters) and the Section 25D credit (30% with no cap for solar water heaters) both expired for property placed in service after Dec 31, 2025 under the OBBBA (PL 119-21, signed July 4, 2025). For 2026 installs, the active federal pathways are IRA HEAR (income-qualified, up to $1,750 for water heaters) and HOMES (performance-based, open to all incomes); state and utility rebates often stack. Standard gas and electric tanks never qualified for federal credits. Carryforward of an unused pre-2026 25D credit is allowed (unlike 25C). (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)"
  },
  {
