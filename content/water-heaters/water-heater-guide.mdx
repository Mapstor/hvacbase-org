...
<ComparisonTable
  title="Estimated Annual Water Heating Costs (Family of 4, ~55 gal/day) — illustrative, see the calculator"
  ...
  rows={[
    ...
    ["Electric Tank (Standard)", "0.93", "4,500 kWh", "$0.18/kWh", "$720"],
    ["Electric Tankless", "0.98", "4,275 kWh", "$0.18/kWh", "$684"],
    ["Heat Pump (Hybrid)", "3.50", "1,200 kWh", "$0.18/kWh", "$192"],
    ["Solar w/ Electric Backup", "2.50", "1,700 kWh equiv.", "$0.18/kWh", "$272"],
  ]}
/>
...
- **Best overall value (electric homes):** Heat pump water heater — hands down, on operating cost alone. The 30% federal tax credit expired for units placed in service after Dec 31, 2025 under the OBBBA, but state/utility rebates plus IRA HEAR and HOMES programs still apply for 2026 installs.
