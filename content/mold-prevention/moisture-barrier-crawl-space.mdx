...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Yes, crawl space encapsulation reduces radon entry because the sealed vapor barrier blocks the primary pathway for radon gas to enter from the soil. For homes with elevated radon (above 4 pCi/L), encapsulation can be combined with a sub-membrane depressurization system — essentially a radon mitigation pipe installed under the vapor barrier that vents radon gas to the exterior. This combined approach typically reduces radon to well below 2 pCi/L."
  },
  {
