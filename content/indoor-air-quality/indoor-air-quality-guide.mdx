...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Yes, significantly. During winter, homes are sealed tight, ventilation rates drop by 50–75%, and heating systems circulate dry air that irritates airways. CO2 and VOC levels are typically 30–50% higher in winter versus summer. Heating combustion (gas furnaces, fireplaces) adds CO and NO2. Low humidity (\`less than <30%lt;30%\`) dries mucous membranes and increases virus survival. Winter is when IAQ interventions — particularly ventilation and humidity management — matter most."
  }
]} />
