...
|------------|-------------------|-------------------|----------------------|
| Mold spores | `<outdoor levels` (ACGIH) | >1,000 spores/m³ | Allergic reactions, respiratory issues |
...
For a plain-English walk-through of what to measure, how to interpret PM2.5 / CO₂ / VOC readings, and which mitigations move each number in practice, see our guide on [how to improve indoor air quality](/how-to-improve-indoor-air-quality).
...
|-----------|-------------|--------------|-------------|----------|------------------------|
| PM2.5 (24-hr) | 35 µg/m³ | 15 µg/m³ | — | — | `<15 µg/m³` |
| PM2.5 (annual) | 12 µg/m³ | 5 µg/m³ | — | — | `<5 µg/m³` |
| CO2 | — | — | `<1,000 ppm above outdoor` | 5,000 ppm | `<1,000 ppm` |
