...
|------------|-------------------|-------------------|----------------------|
| Mold spores | `less than spores/m³` | >1,000 spores/m³ | Allergic reactions, respiratory issues |
| Dust mites | `2 or less µg/g allergen` | >10 µg/g allergen | Asthma trigger |
| Pet dander (Fel d 1) | `less than lt;1 µg/g` | >8 µg/g | Allergic reactions |
| Bacteria | `less than CFU/m³` | >1,000 CFU/m³ | Infection risk |
...
|-----------|-------------|--------------|-------------|----------|------------------------|
| PM2.5 (24-hr) | 35 µg/m³ | 15 µg/m³ | — | — | `less than µg/m³` |
| PM2.5 (annual) | 12 µg/m³ | 5 µg/m³ | — | — | `less than lt;5 µg/m³` |
| CO2 | — | — | `<1,000 ppm above outdoor` | 5,000 ppm | `less than ppm` |
| CO (8-hr) | 9 ppm | 4 ppm (24-hr) | — | 50 ppm | `2 or less ppm` |
...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Yes, significantly. During winter, homes are sealed tight, ventilation rates drop by 50–75%, and heating systems circulate dry air that irritates airways. CO2 and VOC levels are typically 30–50% higher in winter versus summer. Heating combustion (gas furnaces, fireplaces) adds CO and NO2. Low humidity (\`less than 30%\`) dries mucous membranes and increases virus survival. Winter is when IAQ interventions — particularly ventilation and humidity management — matter most."
  }
]} />
