...
|-------------|-------------|---------------|---------------|----------|-------|
| MERV 4 | 20% | `less than 20%` | `less than 20%` | `less than 20%` | `less than 20%` |
| MERV 8 | 70% | 20–35% | `less than 20%` | 20–35% | `less than 20%` |
...
|-------------------|------------|------------|----------|----------------|-------------------|
| `less than 20% RH` | Dormant | Dormant | Minimal | High | Very poor (dried airways) |
