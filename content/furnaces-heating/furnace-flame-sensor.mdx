...
<ComparisonTable
  ...
  headers={["Option", "Cost", "When to Choose"]}
  rows={[
    ["DIY cleaning", "$0", "First attempt; sensor looks intact"],
    ["DIY replacement", "$8–$25 (part)", "Cleaning didn't work; sensor corroded"],
    ["Professional cleaning", "$80–$200 (service call)", "Not comfortable with DIY"],
    ["Professional replacement", "$120–$250 (part + labor)", "Sensor worn out; include in tune-up"],
  ]}
/>
