...
The three main furnace types — gas, electric, and oil — differ dramatically in operating cost, installation price, and efficiency. Natural gas is the most common home heating fuel in the U.S., followed by electricity, while oil heating is now concentrated mostly in the Northeast (per U.S. EIA residential energy data).
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Prevalence (U.S.)", "Most common", "Common", "Regional (Northeast)"],
  ]}
...
Use the calculator below to size your system — as a rule of thumb, plan on roughly 30–40 BTU per square foot in mild climates and 50–60+ BTU per square foot in cold climates, but treat that only as a sanity check against a proper Manual J load calculation.
