...
<ComparisonChart
  ...
  metrics={[
    { label: "Peak heating efficiency (%)", a: 96, b: 300, format: "number", aNote: "AFUE", bNote: "COP 3.0 equivalent AFUE" },
  ...
  desc="Gas furnace vs heat pump compared on the article's own cited figures. Heat pump peak efficiency (COP 3.0 = 300% equivalent AFUE) is over 3x a 96% gas furnace — but only when it's mild enough. Mild-climate (Zone 1-2, Miami/Houston) annual heating cost midpoints show heat pump wins by $50 ($300 vs $250). Cold-climate (Zone 6, Minneapolis/Boston) midpoints show furnace wins by $400 ($1,350 vs $1,750). Gas furnace lifespan averages 19 years vs 13.5 for heat pump. Climate suitability is directly visualized by the mild vs cold operating-cost bars — furnace favored in Zones 5-7 (cold), heat pump favored in Zones 1-4 (mild-to-moderate)."
  caption="All midpoints from the article's own tables. Furnace favored in Zones 5-7 (cold); heat pump favored in Zones 1-4 (mild-to-moderate)."
/>
