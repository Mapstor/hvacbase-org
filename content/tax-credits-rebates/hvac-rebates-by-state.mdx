...
**Your state is now your best source for HVAC savings.** With the federal Section 25C tax credit terminated for installs after December 31, **2025** (OBBBA, signed July 4, 2025) — and Section 25D post-OBBBA status {{NEEDS-VERIFICATION}} — state-administered rebate programs and utility incentives are the primary financial tools for reducing HVAC upgrade costs in 2026. Depending on your state, income level, and utility provider, you could save $2,000 to $14,000+ on a new heat pump system.
