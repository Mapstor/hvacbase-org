...
**Your state is now your best source for HVAC savings.** Both federal HVAC tax credits — **Section 25C** (Energy Efficient Home Improvement Credit) and **Section 25D** (Residential Clean Energy Credit, which covered **geothermal heat pumps**, solar, and home batteries) — were terminated by the One Big Beautiful Bill Act (OBBBA, signed July 4, 2025) for property placed in service after **December 31, 2025**. Equipment installed in 2026 does not qualify for either federal credit (no grandfather, no transition relief; the trigger is "placed in service"). State-administered rebate programs and utility incentives are now the primary financial tools for reducing HVAC upgrade costs in 2026. Depending on your state, income level, and utility provider, you could save $2,000 to $14,000+ on a new heat pump system. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)
...
Once you know your federal credit and utility rebate amounts, plug them in here to see exact annual savings, payback period, and 15-year ROI for your specific upgrade:
