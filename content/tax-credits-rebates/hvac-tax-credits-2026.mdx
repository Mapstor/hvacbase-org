...
**Key Takeaways:**
- **'Placed in service' — meaning fully installed and operational — is the only trigger date.** Signing a contract, paying a deposit, or taking delivery in 2025 does not preserve 25C eligibility if commissioning slips into 2026; OBBBA provides no grandfather clause or transition relief. (Source: IRS 'placed in service' definition; see the 'Placed in service is the key date' Callout in the Federal Tax Credits section.)
