...
**Key Takeaways:**
- **The Inflation Reduction Act rewrote 25C starting January 1, 2023**, taking the rate from 10% to 30% and swapping the old $500 lifetime cap for annual caps that reset each year — a structure that rewarded phased upgrades across multiple tax years.
