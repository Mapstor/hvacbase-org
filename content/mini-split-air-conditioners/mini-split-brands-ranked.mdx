...
| Series | Type | SEER2 (verified where shown) | HSPF2 (verified where shown) | Noise (Indoor) | Best For |
|--------|------|------------------------------|------------------------------|-----------------|----------|
| Aurora 12K (FTXV12AVJU9/RXT12AVJU9) | Wall-mount (cold-climate) | **20.0–21.0** | **10.2** | 19 dB | Cold climates, premium |
| Aurora (other capacities) | Wall-mount (cold-climate) | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 19 dB | Cold climates, premium |
| Emura (DERA) | Wall-mount (designer) | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 21 dB | Aesthetics, modern homes |
| Quaternity (DERA) | Wall-mount (4-way airflow) | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 22 dB | Advanced airflow, humidity control |
| Fit (DERA) | Wall-mount (value) | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 24 dB | Budget-conscious, mild climates |
| Ceiling cassette | Cassette | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 27 dB | Open plans, commercial |
| Slim duct | Concealed | {{PENDING-RESEARCH}} | {{PENDING-RESEARCH}} | 29 dB | Whole-home, hidden |

Source for the Aurora 12K row: totalhomesupply manufacturer spec; hvacdirect 230V listing; Daikin submittal PDF.
...
Carrier's real ductless families are **Comfort** (40MHHQ-series), **Performance** (40MAHB), and **Infinity** (38MPRAQ / 40MPHAQ). Manufacturer-published efficiency tops out in the low-20s SEER2 on the Infinity line; we have not pulled the AHRI cert ID for a specific 12K SKU yet, so we don't list a headline SEER2 here. ({{PENDING-AHRI}} — Carrier Infinity 38MPRAQ.)

**Best for:** Homeowners who want a familiar brand name, easy access to local contractors, and don't want to research smaller specialty brands.
...
| Metric | Senville LETO SENL-12CD | Source |
|--------|------------------------|--------|
| SEER2 | **21.2 (115V) / 21.3 (230V)** | Senville LETO spec sheet |
| EER2 | 10.1 (115V) / 10.8 (230V) | Senville LETO spec sheet |
| HSPF2 | 8.7 (Region IV) / 6.7 (Region V) | Senville LETO spec sheet |
| Min indoor noise | 28 dB | Senville LETO spec sheet |
| Min heating temp | **-13°F / -25°C** spec (effective to ~5°F per marketing) | Senville LETO spec sheet |
| Refrigerant | **R-454B** | Senville LETO spec sheet |
| Compressor + parts warranty | **10 years / 10 years** | Senville LETO spec sheet |
| Price (12K) | $600–$900 | Distributor listings |

**Strengths:** Unbeatable price. A Senville LETO SENL-12CD 12,000 BTU unit costs $600–$900 — roughly half the price of a comparable MrCool and one-third the price of Mitsubishi. The 10-year compressor + 10-year parts warranty per the manufacturer spec sheet is unusually strong for a budget unit.

**Weaknesses:** You get what you pay for. Thinner copper line sets, noisier operation (28 dB indoor minimum), less precise temperature control, and tech support that can be difficult to reach. Per the spec sheet, heating is rated to -13°F / -25°C with marketing-stated effective operation down to ~5°F; the older "down to -22°F" claim is not on the spec sheet.
...
| Daikin | Aurora 12K (FTXV12AVJU9/RXT12AVJU9) | 20.0–21.0 | $1,500–$1,900 | $3,200–$4,500 |
...
| Senville | LETO SENL-12CD | 21.2–21.3 | $600–$900 | $1,500–$2,500 |
...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "Mitsubishi and Daikin are widely recommended among HVAC contractors. Both brands are valued for installation manual quality, manufacturer-run installer training programs, strong parts availability, and warranty terms. Carrier is also popular due to its dealer network."
    },
    {
