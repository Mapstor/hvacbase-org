...
<DryModeVsCoolMode caption="Same evaporator coil below the dew point in both modes — the only physical difference is fan speed and compressor capacity. Cool mode blasts air (fire hose); dry mode moves air slowly across the coil (squeegee) to maximize contact time and moisture removal per cubic foot processed." />
