...
A 12,000 BTU mini split uses 400–1,200 watts depending on compressor load, consuming 3.2–9.6 kWh per day when running 8 hours. Over a full cooling season, that's 500–900 kWh. Use the calculator above for your exact seasonal cost — as a rule of thumb, expect a few dollars a day in mild weather and more during peak season, scaled to your local rate. Inverter-driven mini splits average 30–50% less electricity than these maximum wattage figures because they modulate compressor speed rather than running at full power.
...
<DataChart
  data={[
    { label: "6,000 BTU", value: 275, note: "range 200-350 W" },
    { label: "9,000 BTU", value: 375, note: "range 250-500 W" },
    { label: "12,000 BTU", value: 525, note: "range 350-700 W" },
    { label: "18,000 BTU", value: 850, note: "range 600-1,100 W" },
    { label: "24,000 BTU", value: 1200, note: "range 900-1,500 W" },
    { label: "36,000 BTU", value: 1850, note: "range 1,400-2,300 W" }
  ]}
  title="Mini Split Typical Wattage (Cooling Mode, Inverter Average)"
  desc="Typical average watts drawn in cooling mode by each mini-split BTU size, from the article's own wattage table. Inverter mini splits rarely run at full rated wattage — they typically operate at 30-70% capacity once the room reaches setpoint. Midpoints shown: 6K = 275W, 9K = 375W, 12K = 525W, 18K = 850W, 24K = 1,200W, 36K = 1,850W. Full ranges (per bar) in the notes. Rated (max) watts are roughly 2x these averages. Heating mode adds 10-30% at mild outdoor temps and dramatically more in extreme cold (see the article's heating wattage table)."
  yLabel="Typical (average) watts"
  unit=" W"
  caption="Midpoints of the article's Typical Watts (Avg) column for cooling mode. Full ranges in each bar's note. Rated (max) watts are roughly double these averages; heating mode consumes 10-30% more at mild temps, much more in cold."
/>
...
### Worked Example 1: 18K BTU in Portland, OR (Mild Climate)
...
- **Cost:** Use the calculator above for your exact figure — at Oregon's below-average rate and this light usage, a full cooling season costs only a modest amount.

### Worked Example 2: 24K BTU Heating in Minneapolis, MN (Cold Climate)
...
- **Cost:** Use the calculator above for your exact heating cost — sustained deep-cold heating like this is the costliest scenario, with a steep monthly bill during peak cold and a significant seasonal total.

### Worked Example 3: Multi-Zone 36K BTU in Atlanta, GA
...
- **Cost:** Use the calculator above for your exact figure — running two zones through a Georgia cooling season costs a moderate amount spread across the summer.
...
| System Type | Watts (Avg) | kWh/Day (8 hrs) | kWh/Month |
|-------------|-------------|-----------------|-----------|
| Mini split 12K (SEER2 20) | 350–500 | 2.8–4.0 | 84–120 |
| Window AC 12K (EER 12) | 1,000 | 8.0 | 240 |
| Portable AC 12K (EER 8) | 1,500 | 12.0 | 360 |
| Central AC 12K (SEER2 15) | 550–800 | 4.4–6.4 | 132–192 |

Use the calculator above for your exact monthly cost — as a rule of thumb, a mini split runs at most a few dollars a day, while a window or portable unit of the same capacity costs roughly two to three times as much to run.

### Heating Comparison (Same 400 sq ft Room, 40°F Outdoor)

| System Type | Watts (Avg) | kWh/Day (12 hrs) | kWh/Month |
|-------------|-------------|-----------------|-----------|
| Mini split 12K heat pump (HSPF2 10) | 400–700 | 4.8–8.4 | 144–252 |
| Electric baseboard (1,500W) | 1,500 | 18.0 | 540 |
| Electric space heater (1,500W) | 1,500 | 18.0 | 540 |
| Electric furnace (5 kW, cycling) | 2,500 avg | 30.0 | 900 |

Use the calculator above for your exact monthly heating cost — as a rule of thumb, a mini split heat pump costs roughly a third to a half of what electric baseboard, space heaters, or an electric furnace cost to deliver the same heat.
...
**Improve room insulation.** Adding weatherstripping, insulating window film, or thermal curtains reduces your room's heat gain/loss, meaning the mini split works less. A modest (around $50) investment in window film can measurably reduce your annual electricity use.

## Electricity Rates and Annual Usage by State (12,000 BTU Mini Split, SEER2 20)

Electricity rates vary enormously by state, and so does seasonal usage. Below are published average rates alongside typical annual kWh for a 12K mini split in each state. Use the calculator above for your exact cost — multiply your own usage by your rate, and expect a modest annual figure in low-rate states but noticeably more where power is expensive.

| State | Avg Rate ($/kWh) | Annual Cooling kWh | Annual Heating kWh |
|-------|------------------|-------------------|--------------------|
| Hawaii | $0.37 | 650 | 200 |
...
- **Monthly cost:** Use the calculator above for your exact figure — a single zone typically runs from a few dollars to a few tens of dollars a month depending on climate, usage, and rate
...
- **Your electricity rate matters enormously** — the same unit can cost several times more to run in a high-rate state like Hawaii than in a low-rate state like Idaho; run your own rate through the calculator above
</Callout>
  ...
  items={[
    {
      ...
      answer: "Use the calculator above for your exact 24/7 cost. Running a 12,000 BTU mini split (SEER2 20) continuously for a month typically lands in the low tens of dollars rather than the hundreds, because the inverter throttles down once the room reaches setpoint. The unit won't actually draw full power for 24 hours straight — once the room reaches the set temperature, the inverter reduces compressor speed to maintenance levels (30–50% capacity). Actual 24/7 cost depends heavily on insulation quality, outdoor temperature, and your thermostat setpoint."
    },
    {
