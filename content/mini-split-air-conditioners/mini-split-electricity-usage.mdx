...
A 12,000 BTU mini split uses 400–1,200 watts depending on compressor load, consuming 3.2–9.6 kWh per day when running 8 hours. Over a full cooling season, that's 500–900 kWh — roughly $90–$162 (illustrative, at the national-average electricity rate of about $0.18/kWh). Inverter-driven mini splits average 30–50% less electricity than these maximum wattage figures because they modulate compressor speed rather than running at full power.
...
| System Type | Watts (Avg) | kWh/Day (8 hrs) | kWh/Month | Monthly Cost (illustrative at ~$0.18/kWh — use the calculator) |
|-------------|-------------|-----------------|-----------|---------------------|
...
| System Type | Watts (Avg) | kWh/Day (12 hrs) | kWh/Month | Monthly Cost (illustrative at ~$0.18/kWh — use the calculator) |
|-------------|-------------|-----------------|-----------|---------------------|
...
| National Average | $0.18 | 600 | $108 | 600 | $108 |
  ...
  items={[
    {
      ...
      answer: "Running a 12,000 BTU mini split (SEER2 20) continuously for a month costs approximately $42–$69 (illustrative, at about $0.18/kWh). The unit won't actually draw full power for 24 hours straight — once the room reaches the set temperature, the inverter reduces compressor speed to maintenance levels (30–50% capacity). Actual 24/7 cost depends heavily on insulation quality, outdoor temperature, and your thermostat setpoint."
    },
    {
