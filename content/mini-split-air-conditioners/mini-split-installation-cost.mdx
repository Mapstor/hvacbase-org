...
These prices include equipment, labor, materials, and basic electrical work. Below you'll find a line-item cost breakdown for every component, plus real-world pricing for single-zone, multi-zone, and DIY scenarios. We also cover the 2026 incentive landscape — the federal Section 25C heat-pump tax credit (up to $2,000 for qualifying mini-splits) **expired Dec 31, 2025 under the OBBBA** (PL 119-21, signed July 4, 2025); for 2026 installs, IRA HEAR (income-qualified, up to $8,000 for heat pumps), HOMES (performance-based), and state/utility rebates can still reduce out-of-pocket cost by 20–50% depending on eligibility and program.
...
*Note: the federal 25C/25D tax credits expired Dec 31, 2025 under the OBBBA. For 2026 installs, state and utility rebates (HEAR, HOMES, local utility programs) are the active pathways.

<Callout type="tip">
**The sweet spot for value:** A professionally installed single-zone 12K Fujitsu or LG unit at $2,500–$3,500 delivers premium-tier reliability and efficiency without Mitsubishi's price premium. State and utility rebates ($500–$3,000+ in many states) can lower out-of-pocket further.
</Callout>
...
| Permit | $100 |
| **Total** | **$3,300** |
| Federal 25C tax credit | $0 (expired Dec 31, 2025 — OBBBA) |
| State / utility rebate (varies) | -$0 to -$1,500 |
| **Net cost (no rebate)** | **$3,300** |
| **Net cost (with $1,000 state/utility rebate)** | **$2,300** |
...
| **Total** | **$12,050** |
| Federal 25C tax credit | $0 (expired Dec 31, 2025 — OBBBA) |
| Efficiency Vermont rebate (cold-climate, est.) | -$1,000 |
| IRA HEAR (if income-qualified, up to $8,000) | -$0 to -$8,000 |
| **Net cost (state rebate only, no HEAR)** | **$11,050** |
| **Net cost (state rebate + max HEAR)** | **$3,050** |
...
| **Total** | **$1,870** |
| Federal 25C tax credit | $0 (expired Dec 31, 2025 — OBBBA; also: DIY installs typically didn't qualify even under pre-expiration 25C, which required professional installation) |
| **Net cost** | **$1,870** |
...
| **Total** | **$17,700** |
| Federal 25C tax credit | $0 (expired Dec 31, 2025 — OBBBA) |
| Energize CT rebate (estimated) | -$1,500 |
| IRA HEAR (if income-qualified) | -$0 to -$8,000 |
| **Net cost (state rebate only, no HEAR)** | **$16,200** |
| **Net cost (state rebate + max HEAR)** | **$8,200** |

## Tax Credits and Rebates (2026)

### Federal Tax Credit (25C — EXPIRED for installs after Dec 31, 2025)

The federal Section 25C Energy Efficient Home Improvement Credit (which covered up to **$2,000 per year** for qualifying heat pump installations) **expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). The credit no longer applies to 2026 installs.

**Pre-expiration eligibility (for context on qualifying 2025 installs):**
...
- Credit covered equipment and installation labor
- Claimed on IRS Form 5695

If you installed a qualifying heat pump in 2024 or 2025 and didn't claim the 25C credit, you can typically file an amended return (Form 1040-X) to claim it. 25C does NOT allow carryforward of an unused credit.

For **2026 installs**, the active federal pathways are **IRA HEAR** (income-qualified, point-of-sale rebates up to $8,000) and **IRA HOMES** (open to all incomes, performance-based rebates tied to modeled or measured energy savings), both state-administered. State and utility rebates continue as before. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)
...
<Callout type="tip">
**Stack your 2026 incentives.** The federal 25C credit ($2,000) is no longer available for 2026 installs (expired Dec 31, 2025 — OBBBA). For 2026, you can combine IRA HEAR rebates (up to $8,000, income-qualified) with IRA HOMES rebates (performance-based, open to all incomes) plus state/utility rebates ($500–$3,000+). A low-income homeowner in Massachusetts could theoretically offset $9,000–$13,000 in installation costs through the 2026 stack. Check DSIRE (dsireusa.org) for your area's complete current incentive list.
</Callout>
...
- **Federal 25C tax credit expired** for installs after Dec 31, 2025 (OBBBA); for 2026 installs the active federal pathways are **IRA HEAR** (income-qualified, up to $8,000) and **IRA HOMES** (open to all incomes, performance-based)
- **State/utility rebates add $500–$3,000** depending on location and income
- **Best value strategy (2026):** Mid-tier brand (Fujitsu/LG) + off-season install + stacked state/utility rebates + IRA HEAR or HOMES = $1,500–$3,000 net cost for a single zone (no 25C piece anymore)
</Callout>
...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "The federal Section 25C credit (heat pumps) and Section 25D credit (geothermal/solar/batteries) both expired for property placed in service after Dec 31, 2025 under the OBBBA — there is no federal 25C credit for 2026 installs. Active 2026 pathways: income-qualified IRA HEAR rebates up to $8,000, HOMES rebates (open to all incomes, performance-based), and state/utility incentives of $500–$3,000. Combined, these can still offset 30–60% of installation costs in some states. Check DSIRE (dsireusa.org) for incentives available in your area. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)"
    },
    {
