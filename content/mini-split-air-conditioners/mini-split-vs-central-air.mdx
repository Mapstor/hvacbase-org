...
<ComparisonChart
  optionA={{ name: "Mini-split (mid-tier premium)" }}
  optionB={{ name: "Central air (high-efficiency)" }}
  metrics={[
    { label: "SEER2 rating", a: 22, b: 20, format: "number", aNote: "17-40 typical", bNote: "14-24 typical" },
    { label: "Annual cooling cost", a: 325, b: 550, format: "currency", aNote: "range $250-400", bNote: "range $450-650" },
    { label: "Annual heating cost", a: 390, b: 675, format: "currency", aNote: "range $300-500", bNote: "range $550-800" },
    { label: "Independent zones", a: 5, b: 1, format: "number", aNote: "1-8 typical", bNote: "single thermostat" }
  ]}
  title="Mini-split vs Central air: efficiency, cost, zoning"
  desc="Mini-splits achieve higher SEER2 (22 vs 20 typical for mid-premium/high-eff tiers), lower annual cooling cost ($325 vs $550), lower annual heating cost when operated as a heat pump ($390 vs $675), and native multi-zone control (5 vs 1 thermostat). All figures are midpoints for a 2,000 sq ft home in a moderate US climate; the parenthetical ranges match the article's cited ranges. Cost differences narrow when comparing to central air with existing ductwork."
  caption="Midpoint estimates for a 2,000 sq ft home in a moderate climate; ranges shown in parentheses. Central-air numbers here assume high-efficiency equipment and typical 20-30% duct loss."
/>
...
- Electrical: $600
- **Total: $10,900**
- After typical state + utility rebates ($500–$5,000): **$5,900–$10,400** (federal 25C/25D expired Dec 31, 2025)
...
- Electrical: $300
- **Total: $14,800**
- After typical state + utility rebates ($500–$5,000): **$9,800–$14,300** (federal 25C/25D expired Dec 31, 2025)
...
- Electrical: $800
- **Total: $15,300**
- After typical state + utility rebates ($1,000–$8,000+, e.g. Mass Save): **$7,300–$14,300** (federal 25C/25D expired Dec 31, 2025)

**Option B — Replace Central AC (Carrier 18 SEER2 heat pump):**
- Equipment + installation: $8,500
- Duct sealing/repair: $500
- **Total: $9,000**
- After typical state + utility rebates ($500–$3,000): **$6,000–$8,500** (federal 25C/25D expired Dec 31, 2025)
...
**Mini split (3-zone Fujitsu):** $9,500 installed. SEER2 25, HSPF2 11. Annual energy cost: ~$650. Provides heating and cooling. No ductwork needed. After typical state + utility rebates: $5,500–$8,500 (federal 25C/25D expired Dec 31, 2025).

**Central air + ductwork:** $16,000 installed. SEER2 16, plus existing gas furnace. Annual energy cost: ~$950. After typical state + utility rebates: $13,000–$15,500 (federal 25C/25D expired Dec 31, 2025).
...
**Mini split (5-zone Daikin):** $16,000 installed. SEER2 22, HSPF2 11. Annual energy cost: ~$800. After typical state + utility rebates: $11,000–$15,000 (federal 25C/25D expired Dec 31, 2025).

**Central air replacement (Carrier 18 SEER2 heat pump):** $9,500 installed, including duct sealing. Annual energy cost: ~$1,050. After typical state + utility rebates: $7,500–$9,000 (federal 25C/25D expired Dec 31, 2025).
...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "Cold-climate mini splits maintain effective heating down to -13°F to -22°F depending on the model: Daikin Aurora is rated to -13°F (AHRI-certified), Fujitsu XLTH to -15°F (per Fujitsu General spec), and select Mitsubishi Hyper-Heat / Cooper & Hunter HPR configurations are manufacturer-rated to -22°F. Above 0°F, they're more efficient than gas furnaces. Below -10°F, heating capacity decreases, and in extreme cold (-20°F+), a backup heat source may be needed for the coldest nights. Many cold-climate homeowners use a mini split as primary heat with an existing furnace as backup for extreme cold spells."
    }
  ]}
/>
