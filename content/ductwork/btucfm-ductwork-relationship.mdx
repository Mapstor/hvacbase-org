...
<SourcesBox
  sources={[
  { name: "ACCA Manual J", url: "https://www.acca.org/standards/technical-manuals/manual-j", description: "Residential Load Calculation — the industry standard for determining room-by-room BTU requirements" },
  { name: "ACCA Manual D", url: "https://www.acca.org/standards/technical-manuals", description: "Residential Duct Systems — translating CFM to duct sizes" },
