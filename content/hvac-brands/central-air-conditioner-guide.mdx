...
Central AC capacity is measured in tons. One ton equals 12,000 BTU/hour of cooling capacity. Use the calculator below to size your system — as a rule of thumb, you need roughly 20 BTU per square foot, adjusted for sun, ceilings, and occupancy.
...
| Efficiency Tier | SEER2 Rating | SEER Equivalent | Relative Running Cost |
|---|---|---|---|
| Federal minimum (South) | 15.2 SEER2 | 16 SEER | Highest |
| Federal minimum (North) | 14.3 SEER2 | 15 SEER | Highest |
| ENERGY STAR | 15.2+ SEER2 | 16+ SEER | Lower than minimum |
| Mid-efficiency | 17–19 SEER2 | 18–20 SEER | Lower |
| High-efficiency | 20–22 SEER2 | 21–23 SEER | Much lower |
| Ultra-high (variable speed) | 23+ SEER2 | 24+ SEER | Lowest |

Running cost scales inversely with SEER2: a 22 SEER2 system uses roughly 30% less cooling energy than a 15.2 SEER2 system for the same output. The BTU calculator above sizes your system but does not compute running cost, and actual dollars depend on your local rate, climate, and hours of use. For installed-cost breakdowns by tonnage and region, see our [central AC install cost guide](/central-ac-cost-to-install).
...
Installation labor typically runs $2,000–$5,500 depending on complexity. For a detailed cost breakdown by tonnage, region, and add-ons, see our [central AC install cost guide](/central-ac-cost-to-install).
...
Even the most efficient AC system wastes energy if your ductwork is leaky or poorly designed. The Department of Energy puts duct air losses at about 30% of a cooling system's energy consumption, lost through leaks, holes, and poorly connected sections.
...
The "$5,000 Rule" is a helpful guideline: multiply the age of your system by the repair cost. If the result exceeds $5,000, replace rather than repair. For component-level failure timelines and lifespan by brand, see the [HVAC system lifespan guide](/hvac-system-lifespan).
...
For a head-to-head comparison against window and ductless-mini-split systems (efficiency, cost, and best-use scenarios), see [central air vs mini split vs window AC](/mini-split-vs-central-air).
...
<SourcesBox>
  - [ACCA Manual J](https://www.acca.org/standards/technical-manuals/manual-j) — Residential load calculation standard
