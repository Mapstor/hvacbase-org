...
For a head-to-head comparison against window and ductless-mini-split systems (efficiency, cost, and best-use scenarios), see [central air vs mini split vs window AC](/central-ac-vs-mini-split-vs-window).
