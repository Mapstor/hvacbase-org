...
<Callout type="example">
**Example 3 — Lennox XC25 vs competitors (Miami):** The Riveras wanted the highest possible efficiency for year-round cooling. Lennox XC25 (marketed "up to 26" — the AHRI-certified figure depends on the specific indoor/outdoor match and whether the rating is SEER or SEER2): $13,400 installed. Carrier Infinity at 24 SEER2: $12,100. If the Lennox match certified at or near 26 SEER2, the energy savings vs the Carrier are an estimated $50/year more for $1,300 extra upfront — payback ~26 years. They chose Carrier. Lesson: the efficiency differences between ultra-premium models rarely justify the cost spread, and always verify the AHRI-certified rating for the exact match you're quoted.
</Callout>
