...
<FAQ>
  ...
  <FAQ.Item question="What's the difference between central air and a heat pump?">
    A central AC cools only. A heat pump cools and heats using the same refrigeration cycle in reverse. In cooling mode, they're identical. The cost difference is $1,000–$2,500 more for a heat pump. (Pre-OBBBA, the federal 25C tax credit favored heat pumps with a $2,000 cap vs. $600 for qualifying AC — partially offsetting the heat pump premium. Both buckets of the 25C credit **expired Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025); for 2026 installs, IRA HEAR (income-qualified, up to $8,000 for heat pumps) and HOMES (performance-based) — both heat-pump-focused — restore a similar incentive tilt toward heat pumps over AC for eligible households.) If you're replacing both your AC and gas furnace, a heat pump can potentially replace both units.
  </FAQ.Item>
</FAQ>
