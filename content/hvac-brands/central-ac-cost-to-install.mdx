...
*Based on 1,500 cooling hours/year, $0.18/kWh, 3-ton system (illustrative).
...
A standard AC replacement takes 4–8 hours. If you're weighing whether to replace instead of repair a failing component like a compressor, see our [HVAC system lifespan guide](/hvac-system-lifespan) for the $5,000 rule and component-level failure timelines. Here's the installation timeline:
