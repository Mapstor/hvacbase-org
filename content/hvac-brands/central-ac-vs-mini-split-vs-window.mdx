...
Based on a 3-ton equivalent cooling load (1,800 sq ft home), 1,500 cooling hours/year, $0.18/kWh (illustrative — the dollar figures below are not recomputed at this rate; use the calculator for your own rate):
