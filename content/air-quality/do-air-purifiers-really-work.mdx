...
description: "Do air purifiers work? What EPA guidance and peer-reviewed clinical studies actually show about HEPA filtration for particles, allergens, and asthma — and what it can't do."
...
Yes — for particle removal. [EPA's guidance on residential air cleaners](https://www.epa.gov/indoor-air-quality-iaq/air-cleaners-and-air-filters-home) reports that filtration is an effective supplement to source control and ventilation, and that portable air cleaners and HVAC filters can reduce indoor particle pollution — while noting they cannot remove all pollutants, and that effectiveness depends heavily on filter grade, room size, and how continuously the unit runs. The peer-reviewed studies below show what that looks like in measured homes. The key qualifiers are proper sizing, continuous operation, and realistic expectations.
...
- **HEPA air purifiers work** for particle removal — see the studies table above for measured reductions in specific homes
...
<FAQ items={[
  {
    ...
    answer: "Yes, with qualifications. Multiple randomized controlled trials (Sublett 2011, Butz 2011, Breysse 2014, and others cited above) show HEPA purifiers meaningfully reduce airborne allergen concentrations and, in many studies, reduce symptom frequency for asthmatic occupants. The strongest results come from properly sized units (5+ ACH) running continuously in bedrooms. Air purifiers address airborne allergens but not those in carpets or bedding — combine with allergen-proof covers and HEPA vacuuming for best results."
  },
  {
