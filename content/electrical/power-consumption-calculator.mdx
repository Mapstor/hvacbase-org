...
**The average U.S. household uses 10,500 kWh per year — about 886 kWh per month — costing ≈$159/month at the ~$0.18/kWh national average (EIA, 2026), illustrative; use the calculator for your exact figure.** Your actual bill depends on which appliances you run, how long they operate, and your local electricity rate, which ranges from $0.10/kWh in Louisiana to $0.45/kWh in Hawaii.
...
- At $0.18/kWh: roughly **≈$150/month** (illustrative — use the calculator for exact figures)
- Annual (5 months of heavy use): roughly **≈$755/year**
</Callout>
...
| Appliance | Wattage (Running) | Avg. Hours/Day | Monthly kWh | Monthly Cost ($0.18/kWh — illustrative, use the calculator for exact costs) |
|-----------|-------------------|----------------|-------------|--------------------------|
...
| Appliance | Wattage | Avg. Hours/Day | Monthly kWh | Monthly Cost ($0.18/kWh — illustrative, use the calculator for exact costs) |
|-----------|---------|----------------|-------------|--------------------------|
...
| Appliance | Wattage | Avg. Loads/Week | Monthly kWh | Monthly Cost ($0.18/kWh — illustrative, use the calculator for exact costs) |
|-----------|---------|----------------|-------------|--------------------------|
...
| Charger Type | Wattage | Avg. Hours/Day | Monthly kWh | Monthly Cost ($0.18/kWh — illustrative, use the calculator for exact costs) |
|-------------|---------|----------------|-------------|--------------------------|
...
<Callout type="info">
**EV charging costs vs. gasoline:** At $0.18/kWh, charging a Tesla Model 3 (about 25 kWh per 100 miles) costs roughly ≈$4.50 per 100 miles (illustrative — use the calculator for exact costs). A comparable gas car getting 30 MPG at $3.50/gallon costs $11.67 per 100 miles — nearly 3× more. Off-peak charging at $0.08/kWh drops EV cost to $2.00 per 100 miles.
</Callout>
...
| End Use | % of Total | Annual kWh | Monthly Cost ($0.18/kWh — illustrative, use the calculator for exact costs) |
|---------|-----------|-----------|--------------------------|
...
| Fuel Type | Annual Energy | Unit Cost | Annual Cost (illustrative — use the calculator for exact figures) |
|-----------|-------------|-----------|------------|
| Electric tank (4,500W, 0.95 EF) | 4,773 kWh | $0.18/kWh | ≈$860 |
| Gas tank (40,000 BTU, 0.60 EF) | 258 therms | $1.35/therm | ≈$350 |
| Electric heat pump (COP 3.5) | 1,364 kWh | $0.18/kWh | ≈$245 |
| Tankless gas (0.95 EF) | 163 therms | $1.35/therm | ≈$220 |
| Tankless electric (0.99 EF) | 4,585 kWh | $0.18/kWh | ≈$825 |
...
**Setup:** 2,000 sq ft home converting from gas heating/cooking to all-electric. Current electric usage: 700 kWh/month. Rate: $0.18/kWh (illustrative — see the calculator for exact figures).
...
- **Average U.S. home uses 886 kWh/month** (≈$159/month at the ~$0.18/kWh national average) — your usage depends on climate, home size, and equipment efficiency
- **HVAC is your biggest electricity cost** — space heating, cooling, and water heating account for ~45% of the total bill
- **Tiered rates can triple your marginal cost** — a 5,000W electric furnace at 8 hrs/day adds 40 kWh; that kWh block runs $14.40 on Tier 4 ($0.36) vs. $4.80 on Tier 1 ($0.12), so every extra hour costs far more than the flat-rate calc suggests
...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "A standard 1,500W space heater running 8 hours per day uses 360 kWh per month, costing roughly ≈$65/month at the national average rate (illustrative — use the calculator for exact figures). Running one 24/7 would cost about ≈$195/month. Space heaters are efficient for heating a single room but far more expensive than central heating for an entire home."
  },
  {
