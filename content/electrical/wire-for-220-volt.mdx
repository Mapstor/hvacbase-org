...
- **30A / 240V → 10 AWG copper (bump to 8 AWG in aluminum)** — NEC 240.4(D) caps that 10 AWG at a 30A breaker for non-motor loads, but Article 440 lets motor circuits pair the same wire with a 40A breaker whenever nameplate MCA stays at or below 30A
- **50A / 240V → 6 AWG copper** — but a 48A continuous EV charger (Example 2) needs a 60A breaker via the 125% rule, keeping 6 AWG under NEC 240.4(B)'s next-size-up allowance
