...
- **Motor circuits are the one exception to the 30A cap on 10 AWG** — NEC Article 440 lets 10 AWG copper sit on a 40A breaker when an AC condenser's nameplate MOP requires it, but this never applies to non-motor loads like water heaters or dryers
...
- **Branch and feeder losses stack** — a 130-ft branch on 10 AWG lands at 2.5% alone but 4.5% once a 2% feeder is added, brushing NEC's 5% total guideline; jumping to 8 AWG cuts the branch to 1.6% for about $72 more (see Example 4)
