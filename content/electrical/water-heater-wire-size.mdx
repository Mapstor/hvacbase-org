...
Below you'll find complete wire sizing charts for every common water heater type, from compact 20-gallon tanks to whole-house tankless units. Water heaters use 10/2 cable, not 10/3 — see our [10/2 vs 10/3 wire guide](/10-2-or-10-3-wire-for-ac) for why 240V-only loads don't need a neutral conductor.
...
| Type | Typical Wattage | Wire | Breaker | Annual kWh | Operating Cost ($0.18/kWh — illustrative) |
|------|-----------------|------|---------|-----------|-------------------------------|
...
**NEC's 125% continuous-load multiplier is what forces 30A, not the raw 18.75A draw** — 18.75A × 1.25 = 23.4A of required capacity, so a 12 AWG / 20A setup overheats before it trips even though the nameplate amps look safely under limit
**Whole-house tankless (27 kW+) usually forces a service upgrade before install** — a 27 kW unit pulls 120A across 3 dedicated circuits, more than half a 200A service, and the $1,500–$4,000 panel upgrade is typically the real budget item, not the wiring itself (see Example 3)
