...
<Callout type="tip">
**Heat pump water heaters are the efficiency champions.** They use the same 10/2 wire and 30A breaker as standard tanks but consume 60–70% less energy. The federal 25C credit (which covered up to $2,000 of the purchase price for qualifying ENERGY STAR HPWHs) expired for installs after Dec 31, 2025 under the OBBBA; for 2026 installs, IRA HEAR (income-qualified, up to $1,750 for water heaters) and HOMES (performance-based) plus state/utility rebates still help close the upfront cost gap with standard tanks, while saving $300–$500/year in operating costs.
</Callout>
