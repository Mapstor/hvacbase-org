...
**"Electric tankless are always cheaper to run."** Depends on local utility rates. At $0.15/kWh electricity and $1.35/therm gas, a gas condensing unit costs roughly comparable per gallon of hot water to electric — use the calculator for your exact rates. Below $0.10/kWh, electric wins.
