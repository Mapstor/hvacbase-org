...
The federal Section 25C credit (which offered 30% of cost, up to $2,000 per year, for qualifying high-efficiency water heaters with UEF ≥ 0.95) **expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). The credit no longer applies to 2026 installs.

For 2026 installs, the active federal pathways are:

- **IRA HEAR** (formerly HEEHRA): income-qualified, point-of-sale rebates up to $1,750 for qualifying heat pump or electric tankless water heaters.
- **IRA HOMES**: open to all incomes, performance-based rebates tied to modeled or measured whole-home energy savings.

Both are state-administered; check with your state energy office for current availability and stacking opportunities with utility rebates. (Sources: IRS OBBB FAQ; Congress.gov CRS IN12611.)
...
**Total installed cost:** $3,100 (unit: $1,400, labor: $1,100, gas line upgrade: $400, venting: $200). (Pre-OBBBA, the federal 25C tankless credit at 30% of unit cost — $420 on this $1,400 unit — brought effective cost to $2,680; the 25C credit expired Dec 31, 2025 under the OBBBA (PL 119-21, signed July 4, 2025), so the 2026 effective cost is the full **$3,100**. For 2026 installs, state and utility gas-tankless incentive programs — where available — are the active pathway.)

**Annual operating cost:** ~$230/year on natural gas, down from $380/year with their old 50-gallon tank. **Pre-OBBBA payback (with $2,680 net): 7.2 years. 2026 payback (no federal credit, $3,100 net): ~8.3 years.**
...
- **Federal 25C credit expired** for installs after Dec 31, 2025 (OBBBA); for 2026, check IRA HEAR (income-qualified, up to $1,750) and HOMES (performance-based) plus state/utility rebates
</Callout>
