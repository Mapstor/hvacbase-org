...
State energy offices administer rebate programs that often stack on top of federal pathways. Check DSIRE (dsireusa.org) for programs in your area.

<ComparisonTable
  title="Example State Rebate Programs (2026)"
  headers={["Program", "Rebate Amount", "Requirements"]}
  rows={[
    ["California SGIP", "$200–$500", "ENERGY STAR certified, installed by licensed contractor"],
