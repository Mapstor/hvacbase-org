...
**Key Takeaways:**
- Identify your meter at the service entrance near the main panel — a cycling LCD that rotates screens every 5-10 seconds is a smart AMI meter, a static single-number LCD is older AMR, and 4-5 mechanical dials means analog
...
- A bill-vs-meter gap over 5% signals estimated reads, a serial-number mismatch, or a wrong rate plan — 1-2% drift is normal timing noise
