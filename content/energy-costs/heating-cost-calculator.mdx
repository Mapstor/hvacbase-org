...
**Federal Section 25C and 25D credits — EXPIRED for installs after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025):
- **Air-source heat pumps (25C)**: was 30% credit up to $2,000; EXPIRED. Replaced by IRA HEAR (income-qualified, up to $8,000) + HOMES.
- **Geothermal systems (25D)**: was 30% credit (no cap); EXPIRED. Carryforward of unused pre-2026 25D credit allowed (25C does not allow carryforward).
- **Cold-climate heat pumps**: state and utility rebates remain active in 2026; check DSIRE for local programs.
...
<RelatedArticles articles={['gas-vs-electric-heating-cost', 'heat-pump-guide', 'afue-rating-explained', 'furnace-sizing-calculator']} />
