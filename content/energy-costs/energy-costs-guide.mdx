...
| Fuel Type | Avg Price (2026) | Unit | Cost per Million BTU (illustrative) |
|---|---|---|---|
| Natural Gas | $1.22/therm | Therm | $12.20 |
| Electricity | $0.18/kWh | kWh | $49.24 |
...
- Climate-related loads (heating, cooling, water heating) drive ~60% of the typical bill — lighting and electronics together add only ~16%
