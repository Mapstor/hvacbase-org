...
**Cost at average rate:** ≈**$1.43 per full tank heat-up** at ~$0.18/kWh (illustrative — use the calculator)

If your family drains and reheats the equivalent of one full tank per day, that's approximately $43/month for water heating — consistent with national averages.
...
At ~$0.18/kWh: ≈**$112** to heat the pool (electricity only, illustrative)

With a heat pump pool heater (COP 5.0): 623 kWh ÷ 5.0 = 124.6 kWh, or ≈**$22** at ~$0.18/kWh (illustrative) — about 80% cheaper.
...
At ~$0.18/kWh (electric tank, 92% efficient): ≈**$0.48 per shower** (illustrative — use the calculator)

For a family of four showering daily, that's roughly **$700/year** on shower water heating alone (illustrative).

With a low-flow 1.5 GPM showerhead: 15 gallons, 6,255 BTU, 1.83 kWh — roughly **$0.36/shower, ~$525/year** at ~$0.18/kWh. Savings: **≈$175/year** from a $15 showerhead.
...
**Key Takeaways:**
- Q = mcΔT ranks materials sharply — a pound of concrete (c = 0.21) or air (c = 0.24) absorbs only a fifth to a quarter of what water (c = 1.0 BTU/(lb·°F)) absorbs per degree, which is why water anchors the reference scale at 1.0
...
- Heating 50 gallons of water from 55°F to 120°F requires about 8 kWh (≈$1.43 at ~$0.18/kWh)
