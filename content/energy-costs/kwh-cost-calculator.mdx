...
description: "Calculate your electricity cost per kWh, daily, monthly, and annual. Use real 2026 rates by state. The average US residential rate is 18¢/kWh — find yours and see exactly what your appliances cost to run."
...
One kilowatt-hour (kWh) costs an average of **$0.18 in the United States** as of 2026, but your actual cost ranges from $0.105/kWh in Idaho to $0.421/kWh in Hawaii. Use the calculator below to convert kWh to dollars using your exact local rate, or use the national average for quick estimates.
...
For example, a 1,500W space heater running for 8 hours uses (1,500 × 8) ÷ 1,000 = 12 kWh. At ~$0.18/kWh that's ≈**$2.16** — use the calculator for your exact figure.

Run that heater 8 hours daily for a month (30 days) and you'll use about 360 kWh, roughly ≈**$65/month** at ~$0.18/kWh.
...
At the national average of $0.18/kWh, each of these scenarios costs you about **18 cents**. In Hawaii, that same kWh costs 42 cents. In Idaho, just 10.5 cents.

## Common Appliance Costs: What You're Really Paying

Here's what typical household appliances actually cost to operate in 2026, calculated at the national average rate of $0.18/kWh (illustrative — the appliance tables below use this basis; use the calculator for exact costs).
...
**Gasoline equivalent (30 MPG, $3.20/gal):** 33.3 gal × $3.20 ≈ **$107/month**

Even at California peak rates, the EV costs about 25% less than gasoline. At off-peak TOU rates, it's about 63% cheaper. This is why [time-of-use rates](/time-of-use-rates-explained) matter enormously for EV owners.
...
| Electricity (resistance heat) | $0.18/kWh | 100% | $49.24 |
| Electricity (heat pump, COP 3.0) | $0.18/kWh | 300% | $16.41 |
| Electricity (heat pump, COP 4.0) | $0.18/kWh | 400% | $12.31 |
| Propane | $2.85/gallon | 95% AFUE | $32.75 |
| Heating Oil | $3.95/gallon | 85% AFUE | $33.50 |
| Wood Pellets | $280/ton | 80% | $21.34 |

*The electricity rows use a ~$0.18/kWh basis (illustrative — use the calculator for exact costs).*
...
**Key Takeaways:**
- 1 kWh costs $0.18 on average nationally, but ranges from $0.105 to $0.421 by state
- kWh × rate understates real cost on tiered plans (top-tier kWh run ~$0.25 each) and TOU plans (California peak $0.276 vs off-peak $0.14) — multiply by your marginal or peak rate, not the average
...
<FAQ items={[
  {
    ...
    answer: "The national average is about 18¢/kWh in 2026. Rates below 12¢/kWh are considered cheap (common in the Pacific Northwest and parts of the Great Plains), 12–17¢ is average, 17–25¢ is above average, and above 25¢ is expensive (common in New England, California, and Hawaii). However, a 'good' rate depends on your location — 15¢ is great in Massachusetts but high for Washington state."
  },
  {
    question: "How much does it cost to run a 1,500 watt space heater for 24 hours?",
    answer: "A 1,500W heater running 24 hours uses 1,500W × 24 ÷ 1,000 = 36 kWh. At ~$0.18/kWh that's ≈$6.48 per day, or roughly ≈$194 over a month — use the calculator for your exact figure. Space heaters are the most expensive form of electric heating on a whole-home basis, but can be economical for heating a single room while lowering the thermostat for the rest of the house."
  },
  {
