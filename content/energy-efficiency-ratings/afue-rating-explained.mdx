...
**AFUE = (Annual Heat Output &div; Annual Fuel Energy Input) × 100**
...
Standard furnaces use one heat exchanger. After extracting heat from combustion gases, they vent the remaining hot exhaust (around 300–400&deg;F) through a metal flue pipe and out the roof.

Condensing furnaces add a **secondary heat exchanger** that cools exhaust gases further, to the point where water vapor in the exhaust condenses into liquid water. This phase change releases additional heat (called latent heat) that would otherwise be wasted. Exhaust temperatures drop to 100–150&deg;F, cool enough to vent through PVC pipe out a side wall.
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Exhaust Temperature", "300–400&deg;F", "100–150&deg;F"],
...
<FAQ questions={[
  ...
  },
  {
    ...
    answer: "In most cases, yes. A 96% AFUE condensing furnace costs $1,000–$2,500 more than an 80% model but saves 16.7% on annual fuel costs. For a home spending $1,400/year on gas heat, that's $233/year — the upgrade pays back in 6–11 years. In cold climates with high heating bills, the payback is even faster. (Note: the federal 25C credit that previously offered up to $600 for 97%+ AFUE furnaces expired Dec 31, 2025 under the OBBBA; for 2026 installs, state/utility rebates plus IRA HOMES are the active pathways.)"
  },
  {
  ...
  },
  {
    ...
    answer: "Through Dec 31, 2025, the federal 25C credit (30% of cost, up to $600) required a gas furnace to meet ENERGY STAR Most Efficient criteria — 97% AFUE or higher (87%+ AFUE for oil furnaces with ENERGY STAR rating). The 25C credit expired for installs after Dec 31, 2025 under the OBBBA (PL 119-21, signed July 4, 2025); for 2026 installs, the ENERGY STAR Most Efficient threshold remains useful as a target for state/utility rebates and IRA HOMES."
  },
  {
