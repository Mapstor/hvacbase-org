...
- **SEER2 became mandatory for equipment manufactured on or after January 1, 2023** — pre-2023 SEER-labeled inventory can still be legally sold, but it must satisfy the current regional minimum efficiency requirement when installed
...
- **The 1.047 factor is an average across equipment types, not an exact answer for any one unit** — for the specific model you're evaluating, pull the manufacturer's published SEER2 rating rather than converting from an old SEER number.
