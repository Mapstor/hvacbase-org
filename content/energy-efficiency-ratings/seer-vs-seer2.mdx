...
Industry field data consistently shows that typical residential duct systems create 0.3-0.7 in. w.c. of static pressure. Poorly designed or deteriorated systems can reach 0.8-1.0+ in. w.c. The new M1 test uses 0.5 in. w.c., which is a representative middle ground.
