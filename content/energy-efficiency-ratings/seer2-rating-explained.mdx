...
Let's compare a 3-ton (36,000 BTU) AC unit at different SEER2 ratings in a home that runs cooling for 1,500 hours per year at $0.18/kWh (illustrative — see the calculator for exact figures):
...
The payback period tells you how many years of energy savings it takes to recoup the higher upfront cost of a more efficient unit. Here's a simplified comparison for a 3-ton system at $0.18/kWh and 1,500 cooling hours (illustrative — see the calculator for exact figures):
