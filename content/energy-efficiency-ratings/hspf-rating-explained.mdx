...
<FAQ questions={[
  ...
  {
    question: "What HSPF did the federal 25C tax credit require?",
    answer: "Through Dec 31, 2025, the federal 25C credit required heat pumps to meet 9.0 HSPF2 minimum (approximately 10.6 HSPF under the old standard) plus 16+ SEER2 and 12+ EER2. The credit covered up to $2,000 for qualifying heat pumps. **The credit expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). For 2026 installs, state/utility rebates and IRA HEAR (income-qualified, up to $8,000) / HOMES (performance-based) are the active federal pathways — most use the same or similar efficiency thresholds."
  },
  {
