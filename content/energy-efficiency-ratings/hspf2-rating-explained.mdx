...
*Estimated for a 3-ton heat pump, moderate climate (4,000 HDD), $0.18/kWh.
...
For a 3-ton heat pump at ~$0.18/kWh (illustrative — see the calculator for exact figures):
...
<ComparisonTable
  headers={["System", "Rating", "Effective COP", "Cost per 100K BTU ($0.18/kWh, $1.35/therm — illustrative, see the calculator)"]}
  rows={[
