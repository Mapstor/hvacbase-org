...
<FAQ questions={[
  {
    ...
    answer: "Through Dec 31, 2025, the federal 25C credit required central air conditioners to be split systems rated at 17.5+ SEER2 (and 12.0+ EER2). For heat pumps, the threshold was lower: 16.0+ SEER2 with 9.0+ HSPF2. The AC credit was capped at $600, the heat pump credit at $2,000. **The 25C credit expired for property placed in service after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025). The pre-expiration efficiency thresholds remain useful as targets — most state/utility programs and IRA HEAR / HOMES use the same or similar criteria."
  },
  {
  ...
  {
    question: "Could I claim the 25C credit for a heat pump AND a furnace in the same year?",
    answer: "Through Dec 31, 2025, yes — the $2,000 heat pump credit was in a separate sub-category from the $600 furnace credit, so a dual-fuel install (heat pump + gas furnace backup) meeting both efficiency thresholds could claim up to $2,600 on the same tax year. The credit expired for installs after Dec 31, 2025 under the OBBBA; for prior-year installs that didn't claim it at the time, an amended return on Form 1040-X may still recapture the credit."
  },
  {
  ...
  },
  {
    ...
    answer: "Through Dec 31, 2025, federal 25C credits could be combined with state tax credits, utility rebates, and IRA HEAR/HEEHRA rebates — if a state rebate reduced out-of-pocket cost, the 30% federal credit was calculated on the cost after subtracting the rebate. **The federal 25C credit expired for installs after Dec 31, 2025** under the OBBBA (PL 119-21, signed July 4, 2025); for 2026 installs, the stacking question reduces to state tax credits + utility rebates + IRA HEAR (income-qualified, up to $8,000 for heat pumps) + HOMES (performance-based). Consult a tax professional for specifics."
  }
]} />
